...
class OrbitController extends AController {
    ...
    #updateAnimation() {
        ...
        if (this.#distance < camera.nearClipping)
            this.#distance = camera.nearClipping;
        this.#currentDistance += (this.#distance - this.#currentDistance) * this.#delayDistance;
        if (this.#currentDistance < camera.nearClipping)
            this.#currentDistance = camera.nearClipping;
