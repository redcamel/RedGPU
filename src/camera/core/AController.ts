 ...
 * [KO] 파생 컨트롤러에서 update, getCanvasEventPoint 등을 구현하여 다양한 카메라 조작 방식을 지원할 수 있습니다.
 ...
 * [EN] Derived controllers can implement update, getCanvasEventPoint, etc., to support various camera manipulation methods.
 *
 * @remarks
 * [KO] `시스템 전용 클래스입니다.`
