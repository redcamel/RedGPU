...
fn main(@builtin(global_invocation_id) global_id : vec3<u32>) {
    // ?ÑÏó≠ ?∏Ï∂ú ID??Í∏∞Î∞ò???ÑÏû¨ ?Ä???∏Îç±?§Î? Í≥ÑÏÇ∞?©Îãà??
    ...
    // ?§ÌÅ¨Î¶?Í≥µÍ∞Ñ(Screen-Space)??ÏµúÎ??Ä ÏµúÏÜå Ï¢åÌëúÎ•?Í≥ÑÏÇ∞?òÍ≥† View3D SpaceÎ°?Î≥Ä?òÌï©?àÎã§.
    ...
    // ?ÑÏó≠ Z ?∏Îç±?§Ïóê Í∏∞Î∞ò?òÏó¨ Near ?Ä Far??Z ?âÎ©¥??Í≥ÑÏÇ∞?©Îãà??
    ...
    // View3D Space???†Îì§Í≥?Near ?Ä Far??Z ?âÎ©¥??ÍµêÏ†ê??Í≥ÑÏÇ∞?©Îãà??
    ...
    // AABB(DrawDebuggerAxis-Aligned Bounding Box)??ÏµúÏÜå Î∞?ÏµúÎ? Ï¢åÌëúÎ•??Ä?•Ìï©?àÎã§.
