...
class RedGPUContext extends RedGPUContextViewContainer {
    ...
    #resourceManager;
    /** 배경색 */
    #backgroundColor = new ColorRGBA(0, 0, 0, 1);
    /** 디버그 패널 사용 여부 */
    #useDebugPanel = false;
    /** 키보드 입력 버퍼 */
    #keyboardKeyBuffer = {};
    /** 안티앨리어싱 매니저 */
    #antialiasingManager;
    constructor(htmlCanvas, gpuAdapter, gpuDevice, gpuContext, alphaMode) {
        super();
    ...
    #initialize() {
        ...
        eventList.forEach((eventName) => {
            const eventMap = (this.detector.isMobile
                ?
                    {
            ...
            this.#htmlCanvas.addEventListener(eventName, (e) => {
