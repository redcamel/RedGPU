...
function defineVector4_func(propertyInfo: DefineVector4Info) {
 ...
 * ```
 */
const defineVector4 = (target: any, defineInfo: DefineVector4Info | DefineVector4Info[]) => applyProperties(target, defineInfo, defineVector4_func);
