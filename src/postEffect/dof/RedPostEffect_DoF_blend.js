...
export default class RedPostEffect_DoF_blend extends RedBasePostEffect {
	...
	layout( set = ${RedShareGLSL.SET_INDEX_FragmentUniforms}, binding = 3 ) uniform texture2D uBlurTexture;
	layout( set = ${RedShareGLSL.SET_INDEX_FragmentUniforms}, binding = 4 ) uniform texture2D uDepthTexture;
