...
class DOF extends AMultiPassPostEffect {
    ...
    constructor(redGPUContext) {
        ...
        this.#effect_coc = this.passList[0];
        this.#effect_unified = this.passList[1];
        // CoC 파라미터 초기화
    ...
    /** 초점 거리 반환 */
    get focusDistance() { return this.#focusDistance; }
    /** 초점 거리 설정 */
    ...
    /** 조리개 반환 */
    get aperture() { return this.#aperture; }
    /** 조리개 설정 */
    set aperture(value) {
        this.#aperture = value;
    ...
    // 블러 관련 getter/setter
    /** 근거리 블러 크기 반환 */
    get nearBlurSize() { return this.#nearBlurSize; }
    /** 근거리 블러 크기 설정 */
    set nearBlurSize(value) {
        this.#nearBlurSize = value;
        this.#effect_unified.nearBlurSize = value;
    }
    /** 원거리 블러 크기 반환 */
    get farBlurSize() { return this.#farBlurSize; }
    /** 원거리 블러 크기 설정 */
    set farBlurSize(value) {
        this.#farBlurSize = value;
        this.#effect_unified.farBlurSize = value;
    }
    /** 근거리 블러 강도 반환 */
    get nearStrength() { return this.#nearStrength; }
    /** 근거리 블러 강도 설정 */
    set nearStrength(value) {
        this.#nearStrength = value;
        this.#effect_unified.nearStrength = value;
    }
    /** 원거리 블러 강도 반환 */
    get farStrength() { return this.#farStrength; }
    /** 원거리 블러 강도 설정 */
    set farStrength(value) {
    ...
    render(view, width, height, sourceTextureInfo) {
        ...
        const cocResult = this.#effect_coc.render(view, width, height, sourceTextureInfo);
        // 2단계: 통합된 DOF 블러 및 컴포지팅
        return this.#effect_unified.render(view, width, height, sourceTextureInfo, cocResult);
    }
}
Object.freeze(DOF);
export default DOF;
