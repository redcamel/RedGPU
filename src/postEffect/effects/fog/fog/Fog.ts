...
class Fog extends ASinglePassPostEffect {
    ...
    /** 
     * [KO] 안개 밀도. 0~1, 기본값 0.05
     * [EN] Fog density. 0~1, Default 0.05
     */
    #density: number = 0.05;
    /** 
     * [KO] 안개 시작 거리. 기본값 4.5
     * [EN] Fog near distance. Default 4.5
     */
    #nearDistance: number = 4.5;
    /** 
     * [KO] 안개 끝 거리. 기본값 50.0
     * [EN] Fog far distance. Default 50.0
     */
    ...
    /**
     * [KO] 안개 끝 거리를 설정합니다.
     * [EN] Sets the fog far distance.
     * 
     * [KO] nearDistance+0.1 이상
     * [EN] Greater than or equal to nearDistance+0.1
     */
