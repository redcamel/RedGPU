...
class Convolution extends ASinglePassPostEffect {
    ...
    constructor(redGPUContext) {
        super(redGPUContext);
        this.init(redGPUContext, 'POST_EFFECT_CONVOLUTION', createBasicPostEffectCode(this, computeCode, uniformStructCode));
    ...
    set kernel(value) {
        this.#kernel = value;
        let kernelWeight = 0;
        for (const k in this.#kernel)
            kernelWeight += this.#kernel[k];
