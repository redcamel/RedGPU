...
class Box extends Primitive {
    #makeData = (function () {
        ...
        let groupStart;
        let buildPlane;
        buildPlane = function (interleaveData, indexData, componentIndexU, componentIndexV, componentIndexW, directionComponentU, directionComponentV, width, height, depth, gridResolutionX, gridResolutionY, uvSize) {
