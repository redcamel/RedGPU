 ...
 */
const validatePositiveNumberRange = (value, minRange = 0, maxRange = Number.MAX_VALUE) => {
    ...
    if (typeof maxRange !== 'number')
        consoleAndThrowError('Only numbers allowed.');
    if (minRange < 0 || value < 0 || value < minRange || value > maxRange)
        consoleAndThrowError(`Only numbers within the range of [${minRange}, ${maxRange}] are allowed.`);
    return true;
};
