 ...
 */
const validateNumberRange = (value, minRange = -Number.MAX_VALUE, maxRange = Number.MAX_VALUE) => {
    ...
    if (value < minRange || value > maxRange)
        consoleAndThrowError(`Only numbers within the range of [${minRange}, ${maxRange}] are allowed. input : ${value}`);
    return true;
};
