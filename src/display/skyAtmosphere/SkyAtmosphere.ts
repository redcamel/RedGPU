...
class SkyAtmosphere extends ASinglePassPostEffect {
    ...
    render(view: View3D, width: number, height: number, sourceTextureInfo: ASinglePassPostEffectResult): ASinglePassPostEffectResult {
        ...
        if (this.#dirtySkyView) {
            ...
            // [KO] 이제 Irradiance는 Reflection 큐브맵을 적분하여 생성
            // [EN] Now Irradiance is generated by integrating the Reflection cubemap
            this.#irradianceGenerator.render(this.#reflectionGenerator.prefilteredTexture, this.#transmittanceGenerator.lutTexture);
