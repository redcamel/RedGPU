...
const tempFloat32_4 = new Float32Array(4);
...
// 4. Local Matrix 조립 (Translate + Rotation * Scale)
    ...
    #setDrawBuffer(geometry: Geometry | Primitive, lodIndex: number = null) {
        ...
        if (indexBuffer) {
            ...
            drawBufferManager.setIndirectCommand(drawCommandSlot, vertexCount, 1, 0, this.#globalBufferSlotIndex)
        }
    }
