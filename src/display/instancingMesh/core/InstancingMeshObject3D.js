...
class InstancingMeshObject3D {
     ...
     */
    constructor(redGPUContext, location, instancingMesh) {
    ...
    #updateMatrix() {
        ...
        if (this.#instancingMesh.gpuRenderInfo) {
            ...
            //TODO 이걸한방에 해봐야할듯
            this.#redGPUContext.gpuDevice.queue.writeBuffer(vertexUniformBuffer.gpuBuffer, dateByLocation.uniformOffset + dateByLocation.stride * this.#location, new dateByLocation.View(this.modelMatrix));
            this.#redGPUContext.gpuDevice.queue.writeBuffer(vertexUniformBuffer.gpuBuffer, dateByLocation2.uniformOffset + dateByLocation2.stride * this.#location, new dateByLocation2.View(this.normalModelMatrix));
            this.#redGPUContext.gpuDevice.queue.writeBuffer(vertexUniformBuffer.gpuBuffer, dateByLocation3.uniformOffset + dateByLocation3.stride * this.#location, new dateByLocation3.View([this.opacity]));
        }
    }
}
