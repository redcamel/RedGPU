...
class ViewTransform {
     ...
     */
    set camera(value) {
        if (!(value instanceof PerspectiveCamera || value instanceof Camera2D) && !(value instanceof Camera2D) && !(value instanceof OrthographicCamera) && !(value instanceof AController))
            consoleAndThrowError('allow PerspectiveCamera or OrthographicCamera or AController instance');
        this.#camera = value;
    }
    /**
     ...
     * @returns {mat4}
     */
    get noneJitterProjectionMatrix() {
        ...
        if (this.rawCamera instanceof OrthographicCamera) {
            ...
            mat4.ortho(this.#noneJitterProjectionMatrix, -0.5, // left
            0.5, // right
            -0.5, // bottom
            0.5, // top,
            -100000, 100000);
            mat4.scale(this.#noneJitterProjectionMatrix, this.#noneJitterProjectionMatrix, [
     ...
     */
    setJitterOffset(offsetX, offsetY) {
