...
class ViewRenderTextureManager {
     ...
     */
    get renderPath1ResultTextureDescriptor() {
     ...
     * @returns {GPUTextureView}
     */
    get renderPath1ResultTextureView() {
     ...
     * @returns {GPUTexture}
     */
    get gBufferColorResolveTexture() {
     ...
     * @returns {GPUTextureView}
     */
    get gBufferColorResolveTextureView() {
     ...
     * @returns {GPUTexture}
     */
    get gBufferNormalResolveTexture() {
     ...
     * @returns {GPUTextureView}
     */
    get gBufferNormalResolveTextureView() {
     ...
     * @returns {GPUTexture}
     */
    get gBufferMotionVectorTexture() {
     ...
     * @returns {GPUTexture}
     */
    get gBufferMotionVectorResolveTexture() {
     ...
     * @returns {GPUTextureView}
     */
    get gBufferMotionVectorTextureView() {
     ...
     * @returns {GPUTextureView}
     */
    get gBufferMotionVectorResolveTextureView() {
