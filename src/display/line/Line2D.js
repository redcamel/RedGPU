...
class Line2D extends Line3D {
     ...
     */
    // @ts-ignore
    addPoint(x = 0, y = 0, color = this.baseColor, colorAlpha = 1, inX = 0, inY = 0, outX = 0, outY = 0) {
     ...
     */
    // @ts-ignore
    addPointAt(index, x = 0, y = 0, color = this.baseColor, colorAlpha = 1, inX = 0, inY = 0, outX = 0, outY = 0) {
