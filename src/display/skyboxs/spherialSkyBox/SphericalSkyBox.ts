...
import vertexModuleSource from './shader/sphericalVertex.wgsl';
import SphericalSkyBoxMaterial from "./SphericalSkyBoxMaterial";

const SHADER_INFO = parseWGSL(vertexModuleSource)
const UNIFORM_STRUCT = SHADER_INFO.uniforms.vertexUniforms;
const VERTEX_SHADER_MODULE_NAME = 'VERTEX_MODULE_SPHERICAL_SKYBOX'
const VERTEX_BIND_GROUP_DESCRIPTOR_NAME = 'VERTEX_BIND_GROUP_DESCRIPTOR_SPHERICAL_SKYBOX'
const PIPELINE_DESCRIPTOR_LABEL = 'PIPELINE_DESCRIPTOR_SPHERICAL_SKYBOX'
...
class SphericalSkyBox {
    ...
    constructor(redGPUContext: RedGPUContext, skyboxTexture: BitmapTexture) {
        ...
        this._geometry = new Sphere(redGPUContext, 1, 64, 64, 64)
        this._material = new SphericalSkyBoxMaterial(redGPUContext, skyboxTexture)
    ...
    #initGPURenderInfos(redGPUContext: RedGPUContext) {
        ...
        const vertex_BindGroupLayout: GPUBindGroupLayout = resourceManager.getGPUBindGroupLayout('SPHERICAL_SKYBOX_VERTEX_BIND_GROUP_LAYOUT') || resourceManager.createBindGroupLayout(
            'SPHERICAL_SKYBOX_VERTEX_BIND_GROUP_LAYOUT',
        ...
        mat4.scale(this.modelMatrix, this.modelMatrix, [5000, 5000, 5000]); 	//TODO 카메라 farClip 받도록 수정
