...
class PickingManager {
    ...
    get pickingGPUTexture() {
        return this.#pickingGPUTexture;
    }
    get pickingGPUTextureView() {
        return this.#pickingGPUTextureView;
    }
    get pickingDepthGPUTextureView() {
    ...
    #readPixelArrayBuffer = async (view, time, width = 1, height = 1) => {
        ...
        let readPixelBuffer = this.#createReadPixelBuffer(gpuDevice, width, height, x, y);
    ...
    #createPickingTable = () => this.#castingList.reduce((prev, curr) => {
        prev[curr.pickingId] = curr;
        return prev;
    }, {});
    #createReadPixelBuffer = (gpuDevice, width, height, x, y) => {
    ...
    #processClickEvent = (uint32Color, mouseX, mouseY, time, pickingTable) => {
    ...
    #processEvent = (uint32Color, mouseX, mouseY, time, pickingTable) => {
        const tMesh = pickingTable[uint32Color];
    ...
    #processMouseMove = (uint32Color, tMesh, pickingEvent) => {
