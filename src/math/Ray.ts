...
export default class Ray {
	 ...
	 * @param origin - [KO] 시작점 [EN] Origin
	 * @param direction - [KO] 방향 벡터 [EN] Direction
	 */
	 ...
	 * @returns [KO] 변환된 자신 [EN] The transformed self
	 */
	 ...
	 * @param aabb - [KO] 대상 AABB 박스 [EN] Target AABB box
	 * @returns [KO] 교차 여부 [EN] Whether it intersects
	 */
	 ...
	 * @param v0 - [KO] 정점 0 [EN] Vertex 0
	 * @param v1 - [KO] 정점 1 [EN] Vertex 1
	 * @param v2 - [KO] 정점 2 [EN] Vertex 2
	 * @param backfaceCulling - [KO] 뒷면 컬링 여부 [EN] Whether to use backface culling
	 * @returns [KO] 교차 지점(vec3) 또는 null [EN] Intersection point (vec3) or null
	 */
	 ...
	 * @param v2 - [KO] 정점 2 [EN] Vertex 2
	 * @param backfaceCulling - [KO] 뒷면 컬링 여부 [EN] Whether to use backface culling
	 * @returns [KO] 교차 정보({point, t, u, v}) 또는 null [EN] Intersection info ({point, t, u, v}) or null
	 */
