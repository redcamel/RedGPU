...
const parse_KHR_materials_transmission = (currentMaterial, KHR_materials_transmission, gltfLoader) => {
    ...
    currentMaterial.use2PathRender = true;
    {
        ...
        if (transmissionTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, transmissionTextureInfo, 'KHR_transmissionTexture', null, false);
        }
    }
};
