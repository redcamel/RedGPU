...
const parse_KHR_materials_volume = (currentMaterial, KHR_materials_volume, gltfLoader) => {
    ...
    currentMaterial.transparent = true;
    {
        ...
        if (thicknessTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, thicknessTextureInfo, 'KHR_thicknessTexture', null, false);
        }
    }
};
