...
const parse_KHR_materials_iridescence = (currentMaterial, KHR_materials_iridescence, gltfLoader) => {
    ...
    currentMaterial.transparent = true;
    {
        ...
        if (iridescenceTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, iridescenceTextureInfo, 'KHR_iridescenceTexture', null, false);
        }
        if (iridescenceThicknessTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, iridescenceThicknessTextureInfo, 'KHR_iridescenceThicknessTexture', null, false);
        }
    }
};
