...
const parse_KHR_materials_diffuse_transmission = (currentMaterial, KHR_materials_diffuse_transmission, gltfLoader) => {
    ...
    currentMaterial.transparent = true;
    {
        ...
        if (diffuseTransmissionTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, diffuseTransmissionTextureInfo, 'KHR_diffuseTransmissionTexture', null, false);
        }
        ...
        if (diffuseTransmissionColorTextureInfo) {
            parseMaterialTexture(gltfLoader, currentMaterial, diffuseTransmissionColorTextureInfo, 'KHR_diffuseTransmissionColorTexture', `${navigator.gpu.getPreferredCanvasFormat()}-srgb`, false);
        }
    }
};
