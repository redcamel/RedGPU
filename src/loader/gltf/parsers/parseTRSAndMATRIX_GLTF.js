 ...
 * @returns {void}
 */
const setMeshRotation = (tRotation, mesh) => {
    mesh.setRotation(-(tRotation[0] * RAD_TO_DEG), -(tRotation[1] * RAD_TO_DEG), -(tRotation[2] * RAD_TO_DEG));
};
/**
 ...
 * @returns {void}
 */
const parseTRSAndMATRIX_GLTF = (mesh, nodeInfo) => {
