 ...
 */
const parseSkin_GLTF = (gltfLoader, scenesData, skin, mesh) => {
    ...
    const { startIndex, accessor, componentType_BYTES_PER_ELEMENT, bufferViewByteStride, bufferURIDataView, getMethod } = accessorInfo;
    ...
    for (let i = 0; i < joints.length; i++) {
        parsedSkinInfo.inverseBindMatrices.push(new Float32Array([
