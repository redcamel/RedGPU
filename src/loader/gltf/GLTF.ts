...
/**
 * Image data used to create a texture. Image **MAY** be referenced by  URI (or IRI) or a buffer view index.
 */
...
export interface Material {
	...
	"alphaCutoff"?: number;
	/**
	 * Specifies whether the material is doubleSided.
	 */
	"doubleSided"?: boolean;
