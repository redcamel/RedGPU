...
export default class View extends UUID {
    ...
    updateSystemUniform(passEncoder, redGPUContext) {
        ...
        //     -this.camera.currentDistance * aspect/2, // left
        //     this.camera.currentDistance* aspect/2, // right
        //     -this.camera.currentDistance/2, // bottom
        //     this.camera.currentDistance/2, // top,
        //     -this.camera.farClipping * 2, this.camera.farClipping
        // );
