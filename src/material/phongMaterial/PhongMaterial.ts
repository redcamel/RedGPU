...
class PhongMaterial extends AUVTransformBaseMaterial {
    /** [KO] 머티리얼의 기본 색상(RGB) [EN] Base color of the material (RGB) */
    color: ColorRGB;
    /** [KO] 발광 색상(RGB) [EN] Emissive color (RGB) */
    emissiveColor: ColorRGB;
    /** [KO] 발광 강도 [EN] Emissive strength */
    emissiveStrength: number
    /** [KO] 스펙큘러 색상(RGB) [EN] Specular color (RGB) */
    specularColor: ColorRGB;
    /** [KO] 스펙큘러 강도 [EN] Specular strength */
    specularStrength: number
    /** [KO] 알파(투명도) 텍스처 [EN] Alpha (transparency) texture */
    alphaTexture: BitmapTexture
    /** [KO] 알파 텍스처 샘플러 [EN] Alpha texture sampler */
    alphaTextureSampler: Sampler
    /** [KO] 디퓨즈 텍스처 [EN] Diffuse texture */
    diffuseTexture: BitmapTexture
    /** [KO] 디퓨즈 텍스처 샘플러 [EN] Diffuse texture sampler */
    diffuseTextureSampler: Sampler
    /** [KO] 스펙큘러 텍스처 [EN] Specular texture */
    specularTexture: BitmapTexture
    /** [KO] 스펙큘러 텍스처 샘플러 [EN] Specular texture sampler */
    specularTextureSampler: Sampler
    /** [KO] 발광 텍스처 [EN] Emissive texture */
    emissiveTexture: BitmapTexture
    /** [KO] 발광 텍스처 샘플러 [EN] Emissive texture sampler */
    emissiveTextureSampler: Sampler
    /** [KO] AO(ambient occlusion) 텍스처 [EN] AO (ambient occlusion) texture */
    aoTexture: BitmapTexture
    /** [KO] AO 텍스처 샘플러 [EN] AO texture sampler */
    aoTextureSampler: Sampler
    /** [KO] 노멀 맵 텍스처 [EN] Normal map texture */
    normalTexture: BitmapTexture
    /** [KO] 노멀 맵 텍스처 샘플러 [EN] Normal map texture sampler */
    normalTextureSampler: Sampler
    /** [KO] 노멀 맵 스케일 [EN] Normal map scale */
    normalScale: number
    /** [KO] 금속도 [EN] Metallic */
    metallic: number
    /** [KO] 거칠기 [EN] Roughness */
    roughness: number
    /** [KO] SSR(스크린 스페이스 리플렉션) 사용 여부 [EN] Whether to use SSR (Screen Space Reflection) */
    useSSR: boolean;

    /** [KO] 디스플레이스먼트(변위) 텍스처 [EN] Displacement texture */
    #displacementTexture: BitmapTexture
    /** [KO] 디스플레이스먼트(변위) 스케일 (기본값: 1) [EN] Displacement scale (Default: 1) */
    #displacementScale: number = 1

    /**
     * [KO] PhongMaterial 인스턴스를 생성합니다.
     * [EN] Creates a PhongMaterial instance.
     * @param redGPUContext -
     * [KO] RedGPUContext 인스턴스
     * [EN] RedGPUContext instance
     * @param color -
     * [KO] 초기 기본 색상 (HEX 문자열, 기본값: '#fff')
     * [EN] Initial base color (HEX string, default: '#fff')
     * @param name -
     * [KO] 머티리얼 이름 (선택적)
     ...
     * @param value - [KO] 설정할 비트맵 텍스처 [EN] BitmapTexture to set
     */
