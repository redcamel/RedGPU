...
`;
  ...
  static uniformBufferDescriptor_fragment = [
    ...
    {size: TypeSize.float32, valueName: 'refractionPower'},
    {size: TypeSize.float32, valueName: 'refractionRatio'},
    ...
    {size: TypeSize.float32, valueName: '__refractionTextureRenderYn'},
