...
export default class RedSprite3DMaterial extends RedMix.mix(
	RedBaseMaterial,
    ...
    ${RedShareGLSL.GLSL_SystemUniforms_vertex.getSprite3DMatrix}	
	void main() {
...
`;
	static PROGRAM_OPTION_LIST = ['diffuseTexture', 'useFixedScale'];
