...
export default class RedColorPhongTextureMaterial extends RedMix.mix(
	RedBaseMaterial,
	RedMix.color,
...
`;
	...
	#timeout
	constructor(redGPU, color = '#ff0000', alpha = 1, normalTexture, specularTexture, emissiveTexture, displacementTexture) {
		super(redGPU);
		this.color = color;
		this.alpha = alpha;
