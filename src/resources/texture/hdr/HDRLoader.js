...
class HDRLoader {
     ...
     * 최적 노출값 계산
     */
    #calculateOptimalExposure(stats) {
        ...
        // 🔸 로그 평균 근사 (단순화된 기하평균)
        const logAverage = Math.max(Math.pow(average * median, 0.5), // 기하평균으로 더 안정적인 기준값
        0.001);
        // 🔸 기본 노출 계산
     ...
     */
    #readRGBEScanline(data, offset, width) {
