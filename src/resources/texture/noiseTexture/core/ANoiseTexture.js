...
class ANoiseTexture extends ManagementResourceBase {
    ...
    ///
    #animationSpeed = 1;
    #animationX = BASIC_OPTIONS.animationX;
    #animationY = BASIC_OPTIONS.animationY;
    #videoMemorySize = 0;
    ...
    #executeComputePass() {
        if (!this.#textureComputeBindGroup)
            return;
        ...
        computePassEncoder.dispatchWorkgroups(Math.ceil(this.#width / this.#COMPUTE_WORKGROUP_SIZE_X), Math.ceil(this.#height / this.#COMPUTE_WORKGROUP_SIZE_Y));
    ...
    #createStorageTexture(redGPUContext, width, height) {
        ...
        this.#textureComputeBindGroup = this.#createTextureBindGroup(redGPUContext, this.#textureComputeBindGroupLayout, storageTextureView);
        return storageTexture;
    }
    #createTextureBindGroup(redGPUContext, bindGroupLayout, storageTextureView) {
