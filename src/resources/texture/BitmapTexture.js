...
class BitmapTexture extends ManagementResourceBase {
     ...
     */
    constructor(redGPUContext, src, useMipMap = true, onLoad, onError, format, usePremultiplyAlpha = false) {
    ...
    set src(value) {
        ...
        if (this.#src)
            this.#loadBitmapTexture(this.#src);
    }
    /** 밉맵 사용 여부 반환 */
    get useMipmap() {
     ...
     * @category Texture
     */
    async #convertSvgToImageBitmap(src) {
