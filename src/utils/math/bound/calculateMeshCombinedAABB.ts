...
/**
 * [KO] 모든 자식 메시의 AABB를 재귀적으로 수집합니다.
 * [EN] Recursively collects AABBs of all child meshes.
 *
 * @param mesh -
 * [KO] AABB를 수집할 메시 객체
...
/**
 * [KO] 여러 AABB를 통합하여 전체를 감싸는 AABB를 계산합니다.
 * [EN] Calculates an AABB encompassing multiple AABBs.
 *
 * @param aabbs -
 * [KO] 통합할 AABB 배열
