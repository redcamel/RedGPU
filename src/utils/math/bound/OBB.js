...
export class OBB {
     ...
     */
    constructor(center, halfExtents, orientation) {
        ...
        this.geometryRadius = Math.sqrt(this.halfExtentX ** 2 +
            this.halfExtentY ** 2 +
            this.halfExtentZ ** 2);
    }
    /**
     ...
     */
    clone() {
        return new OBB([this.centerX, this.centerY, this.centerZ], [this.halfExtentX, this.halfExtentY, this.halfExtentZ], this.orientation);
    }
    /**
