import ResourceStateCubeTexture from "../../../resources/core/resourceManager/resourceState/texture/ResourceStateCubeTexture";
...
class DebugStatisticsDomService extends ADebugStatisticsDomService {
    #debugCubeTextureMode;
    constructor(debugCubeTextureMode) {
        super();
    ...
    update(debugRender, redGPUContext) {
        if (this.#debugCubeTextureMode === 'Packed') {
            ...
            const { table, videoMemory, } = this.#debugCubeTextureMode === 'Bitmap' ? managedBitmapTextureState : this.#debugCubeTextureMode === 'Cube' ? managedCubeTextureState : managedHDRTextureState;
    ...
    updateDebugItems(tDom, mipLevelCount, useMipmap, width, height, useNum, cacheKey, targetSrc, videoMemorySize) {
        ...
        if (this.#debugCubeTextureMode !== 'HDR')
    ...
    #updatePackedTexture(debugRender, redGPUContext) {
    ...
    #convertPackedTextureData(cacheMap) {
    ...
    #estimateTextureMemorySize(texture) {
