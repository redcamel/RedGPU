 ...
 *
 * [KO] 색상 변환, 파일 처리, 수학 연산, 텍스처 관리 및 고유 ID 생성 등 핵심 시스템을 지원하는 도구들을 포함합니다.
 * [EN] Includes tools that support core systems such as color conversion, file processing, mathematical operations, texture management, and unique ID generation.
 *
