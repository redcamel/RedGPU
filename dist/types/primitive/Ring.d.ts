 ...
 * @category Primitive
 */
declare class Ring extends Primitive {
    /**
     * [KO] Ring 인스턴스를 생성합니다.
     ...
     */
    constructor(redGPUContext: RedGPUContext, innerRadius?: number, outerRadius?: number, thetaSegments?: number, phiSegments?: number, thetaStart?: number, thetaLength?: number, isRadial?: boolean);
}
export default Ring;
