...
new RedGPU.RedGPUContext(cvs,
	function (v, reason) {
		...
		let particleTest = new Particle(this, 10000, {}, new RedGPU.BitmapTexture(this, '../assets/crate.png'))
		// let particleTest = new Particle(this, 10000, {}, new RedGPU.BitmapTexture(this, '../assets/particle.png'))
