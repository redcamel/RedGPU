...
const renderTestPane = async (targetView, skyAtmosphere) => {
    ...
    const rayleighProxy = {
        get r() { return skyAtmosphere.rayleighScattering[0]; }, set r(v) { const t = skyAtmosphere.rayleighScattering; t[0] = v; skyAtmosphere.rayleighScattering = t; },
        get g() { return skyAtmosphere.rayleighScattering[1]; }, set g(v) { const t = skyAtmosphere.rayleighScattering; t[1] = v; skyAtmosphere.rayleighScattering = t; },
        get b() { return skyAtmosphere.rayleighScattering[2]; }, set b(v) { const t = skyAtmosphere.rayleighScattering; t[2] = v; skyAtmosphere.rayleighScattering = t; }
    };
    ...
    const ozoneProxy = {
        get r() { return skyAtmosphere.ozoneAbsorption[0]; }, set r(v) { const t = skyAtmosphere.ozoneAbsorption; t[0] = v; skyAtmosphere.ozoneAbsorption = t; },
        get g() { return skyAtmosphere.ozoneAbsorption[1]; }, set g(v) { const t = skyAtmosphere.ozoneAbsorption; t[1] = v; skyAtmosphere.ozoneAbsorption = t; },
        get b() { return skyAtmosphere.ozoneAbsorption[2]; }, set b(v) { const t = skyAtmosphere.ozoneAbsorption; t[2] = v; skyAtmosphere.ozoneAbsorption = t; }
    };
    ...
    const groundAlbedoProxy = {
        get r() { return skyAtmosphere.groundAlbedo[0]; }, set r(v) { const t = skyAtmosphere.groundAlbedo; t[0] = v; skyAtmosphere.groundAlbedo = t; },
        get g() { return skyAtmosphere.groundAlbedo[1]; }, set g(v) { const t = skyAtmosphere.groundAlbedo; t[1] = v; skyAtmosphere.groundAlbedo = t; },
        get b() { return skyAtmosphere.groundAlbedo[2]; }, set b(v) { const t = skyAtmosphere.groundAlbedo; t[2] = v; skyAtmosphere.groundAlbedo = t; }
    };
