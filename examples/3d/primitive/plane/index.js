 ...
 *
 * [KO] Plane 프리미티브 생성 및 크기, 세그먼트 속성을 실시간으로 제어하는 방법을 보여줍니다.
 * [EN] Demonstrates how to create a Plane primitive and control its size and segment properties in real-time.
 */
...
const renderTestPane = async (redGPUContext) => {
    ...
    /**
     * [KO] 설정값 변경 시 Plane 지오메트리를 재생성하여 업데이트합니다.
     * [EN] Recreates and updates the Plane geometry when configuration values change.
     */
