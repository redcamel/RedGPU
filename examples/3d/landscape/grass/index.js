...
RedGPU.init(
    ...
    (redGPUContext) => {
        ...
        // 1장의 Channel-Packed Splatmap 텍스처 (R: Layer0, G: Layer1, B: Layer2, A: Layer3)
        ...
        renderTestPane(redGPUContext, landscape, controller, directionalLight, [grassLayer, rockLayer, gravelLayer, leaveLayer], foliageManager, grassType);
    }
);
