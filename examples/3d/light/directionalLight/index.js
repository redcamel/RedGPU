...
// Function to create and add a Directional Light
const createDirectionalLight = (scene) => {
    // Default direction and intensity for the directional light
...
const renderTestPaneWithLightControl = async (redGPUContext, mesh, light) => {
    ...
    // Light configuration including color, direction, and intensity
    const lightConfig = {
    ...
    // Mesh transformation configurations remain the same
    const config = {
        x: mesh.x,
        y: mesh.y,
        z: mesh.z,
    ...
    // Mesh folder for transformations
