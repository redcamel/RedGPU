...
RedGPU.init(
	...
	(redGPUContext) => {
		...
		view.postEffectManager.addEffect(new RedGPU.PostEffect.SSAO(redGPUContext));
...
const renderTestPane = async (redGPUContext, targetView) => {
	...
	pane.addBinding(testData, 'useSSR').on('change', (v) => {
		if (v.value) {
			targetView.postEffectManager.addEffect(new RedGPU.PostEffect.SSAO(redGPUContext))
		} else {
