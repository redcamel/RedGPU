...
/**
 * [KO] Compare Base Color 예제
 * [EN] Compare Base Color example
 *
 * [KO] GLTF Compare Base Color 모델을 로드하고 렌더링합니다.
 * [EN] Loads and renders the GLTF Compare Base Color model.
 */
...
RedGPU.init(
    ...
    (redGPUContext) => {
        ...
        // Load GLTF model
        const MODEL_URL = 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/CompareBaseColor/glTF-Binary/CompareBaseColor.glb';
