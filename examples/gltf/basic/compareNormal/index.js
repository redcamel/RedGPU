...
/**
 * [KO] Compare Normal 예제
 * [EN] Compare Normal example
 *
 * [KO] GLTF Compare Normal 모델을 로드하고 렌더링합니다.
 * [EN] Loads and renders the GLTF Compare Normal model.
 */
...
RedGPU.init(
    ...
    (redGPUContext) => {
        ...
        // Load GLTF model
        const MODEL_URL = 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/CompareNormal/glTF-Binary/CompareNormal.glb';
