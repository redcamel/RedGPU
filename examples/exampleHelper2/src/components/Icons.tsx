...
export const AxisIcon: React.FC<IconProps> = ({ color = defaultColor, size = defaultSize, style, opacity }) => (
    <svg width={size} height={size} viewBox="0 0 14 14" fill={color} style={{ ...style, opacity }} xmlns="http://www.w3.org/2000/svg">
...
export const DebugIcon: React.FC<IconProps> = ({ color = defaultColor, size = 24, style, opacity }) => (
    <svg width={size} height={size} viewBox="0 0 640 640" fill={color} style={{ ...style, opacity }} xmlns="http://www.w3.org/2000/svg">
...
export const GridIcon: React.FC<IconProps> = ({ color = defaultColor, size = 24, style, opacity }) => (
    <svg width={size} height={size} viewBox="0 0 640 640" fill={color} style={{ ...style, opacity }} xmlns="http://www.w3.org/2000/svg">
        <path d="M160 96C124.7 96 96 124.7 96 160v320c0 35.3 28.7 64 64 64h320c35.3 0 64-28.7 64-64V160c0-35.3-28.7-64-64-64H160zm0 32h320c17.7 0 32 14.3 32 32v320c0 17.7-14.3 32-32 32H160c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32z"/>
...
export const ToneMappingIcon: React.FC<IconProps> = ({ color = '#fff', size = 20, style, opacity }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={color} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ ...style, opacity }} xmlns="http://www.w3.org/2000/svg">
...
export const ChevronLeft: React.FC<IconProps & { strokeWidth?: number }> = ({ color = '#fdb48d', size = 14, style, opacity, strokeWidth = 3 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={{ ...style, opacity }}>
        <polyline points="15 18 9 12 15 6"></polyline>
    </svg>
);

export const ChevronRight: React.FC<IconProps & { strokeWidth?: number }> = ({ color = '#fdb48d', size = 14, style, opacity, strokeWidth = 3 }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={{ ...style, opacity }}>
