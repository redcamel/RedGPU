...
import GuiSkybox from './GuiSkybox';
...
const GuiPanel: React.FC = () => {
    ...
    return (
        <>
            ...
            {guiInstance && guiConfig.skybox && redGPUContext && (
                <GuiSkybox gui={guiInstance} redGPUContext={redGPUContext} view={redGPUContext.viewList[0]}/>
            )}
