import {ExampleListType} from '../types/example';
                ...
                list: [
                    {
                        ...
                        path: '3d/shadow/csm',
                        description: {
                            ko: `언리얼 엔진 5 시네마틱 프리셋 수준의 4단 CSM과 PCSS 접촉 경화 소프트 섀도우를 시연하는 종합 예제입니다. 원거리 신전 열주와 부유하는 오브젝트들의 거리별 고해상도 그림자를 확인할 수 있습니다.`,
                            en: `A comprehensive example demonstrating Unreal Engine 5 Cinematic preset level 4-Cascade CSM and PCSS contact-hardening soft shadows across distant colonnades and floating objects.`
                        },
                    },
                    {
