...
RedGPU.init(
    ...
    (redGPUContext) => {
        ...
        viewEffect.postEffectManager.addEffect(new RedGPU.PostEffect.Invert(redGPUContext));
...
const renderTestPane = async (redGPUContext, viewEffect) => {
    ...
    createPostEffectLabel('Invert', redGPUContext.detector.isMobile)
    ...
    folder.addBinding(TEST_STATE, 'Invert').on('change', (v) => {
        if (v.value) view.postEffectManager.addEffect(new RedGPU.PostEffect.Invert(redGPUContext))
