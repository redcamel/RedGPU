...
new RedGPU.RedGPUContext(
	...
	function () {
		...
		tMaterial = new RedGPU.EnvironmentMaterial(this);
		tMaterial.diffuseTexture = new RedGPU.BitmapTexture(this, '../../../assets/Brick03_col.jpg');
		tMaterial.environmentTexture = new RedGPU.BitmapCubeTexture(
			this,
			[
				'../../../assets/cubemap/SwedishRoyalCastle/px.jpg',
				'../../../assets/cubemap/SwedishRoyalCastle/nx.jpg',
		...
		// TestUI setup
		ExampleHelper.setTestUI_EnvironmentMaterial(RedGPU, this, tMaterial, true);
