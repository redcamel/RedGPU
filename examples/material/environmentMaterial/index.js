...
new RedGPU.RedGPUContext(
	...
	function () {
		...
		tMesh = new RedGPU.Mesh(
			...
			new RedGPU.EnvironmentMaterial(this)
		);
		tMesh.material.diffuseTexture = new RedGPU.BitmapTexture(this, '../../../assets/Brick03_col.jpg');
		tMesh.material.environmentTexture = new RedGPU.BitmapCubeTexture(
			this,
			[
				'../../../assets/cubemap/SwedishRoyalCastle/px.jpg',
				'../../../assets/cubemap/SwedishRoyalCastle/nx.jpg',
		...
		tChildMesh.material.environmentTexture = new RedGPU.BitmapCubeTexture(
			this,
			[
				'../../../assets/cubemap/SwedishRoyalCastle/px.jpg',
				'../../../assets/cubemap/SwedishRoyalCastle/nx.jpg',
		...
		// TestUI setup
		ExampleHelper.setTestUI_EnvironmentMaterial(RedGPU, this,tMesh, tMesh.material, true);
