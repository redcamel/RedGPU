...
`,o=`
    graph TD
        ...
        View2 --> CameraY
`;return(m,s)=>{const h=p("MermaidResponsive"),t=p("ClientOnly"),r=p("CodePen");return E(),g("div",null,[s[2]||(s[2]=l("",4)),e(t,null,{default:n(()=>[e(h,{definition:k})]),_:1}),s[3]||(s[3]=l("",7)),e(t,null,{default:n(()=>[e(r,{title:"RedGPU Basics - View3D",slugHash:"view-basic"},{default:n(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),a(`
`),i("p",null,"});"),a(`
`)],-1)])]),_:1})]),_:1}),s[4]||(s[4]=l("",11)),e(t,null,{default:n(()=>[e(h,{definition:o})]),_:1}),s[5]||(s[5]=l("",3)),e(t,null,{default:n(()=>[e(r,{title:"RedGPU Basics - Multi View",slugHash:"view-multi"},{default:n(()=>[...s[1]||(s[1]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
`,-1),i("pre",{"data-lang":"css"},`body { margin: 0; overflow: hidden; background: #111; }
canvas { display: block; width: 100vw; height: 100vh; }
`,-1),i("pre",{"data-lang":"js"},[a(`import * as RedGPU from "https://redcamel.github.io/RedGPU/dist/index.js";
`),i("p",null,'const canvas = document.getElementById("redgpu-canvas");'),a(`
