import{D as e,o as d,c as o,a2 as t,G as n,w as h,k as i,a}from"./chunks/framework.DpNgdNqH.js";const F=JSON.parse('{"title":"Scene","description":"","frontmatter":{"title":"Scene","order":3},"headers":[],"relativePath":"en/view-system/scene.md","filePath":"en/view-system/scene.md","lastUpdated":1770637469000}'),g={name:"en/view-system/scene.md"},m=Object.assign(g,{setup(c){const p=`
    graph TD
...
`)]),a(`
`),i("p",null,"});"),a(`
`)],-1)])]),_:1})]),_:1}),s[3]||(s[3]=t("",9))])}}});export{F as __pageData,m as default};
