import{D as l,c as o,o as k,a2 as r,H as i,k as s,w as a,a as t}from"./chunks/framework.cYGcyyTy.js";const u=JSON.parse('{"title":"Skybox","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"ko/environment/skybox.md","filePath":"ko/environment/skybox.md","lastUpdated":1769496586000}'),g={name:"ko/environment/skybox.md"},b=Object.assign(g,{setup(c){const d=`
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">view.skybox </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> skybox;</span></span></code></pre></div><h2 id="_2-텍스처-생성-방법" tabindex="-1">2. 텍스처 생성 방법 <a class="header-anchor" href="#_2-텍스처-생성-방법" aria-label="Permalink to &quot;2. 텍스처 생성 방법&quot;">​</a></h2><p>SkyBox에 적용할 텍스처를 생성하는 방법은 크게 세 가지로 나뉩니다. 가장 권장되는 방식인 <strong>IBL</strong> 부터 고전적인 <strong>큐브맵</strong> 순으로 살펴봅니다.</p>`,7)),i(n,null,{default:a(()=>[i(p,{definition:d})]),_:1}),e[3]||(e[3]=r(`<h3 id="_2-1-ibl-리소스-활용-권장" tabindex="-1">2.1 IBL 리소스 활용 (권장) <a class="header-anchor" href="#_2-1-ibl-리소스-활용-권장" aria-label="Permalink to &quot;2.1 IBL 리소스 활용 (권장)&quot;">​</a></h3><p><code>RedGPU.Resource.IBL</code> 객체를 생성하면 내부적으로 <strong>환경 텍스처</strong>(Environment Texture) 가 함께 생성됩니다. 이 텍스처를 Skybox에 활용하는 방식입니다.</p><ul><li><strong>장점</strong>: 배경과 완벽하게 일치하는 물리 기반 조명(Diffuse/Specular) 데이터를 함께 얻을 수 있습니다.</li><li><strong>활용</strong>: 가장 사실적인 렌더링 결과를 얻기 위해 주로 사용되는 현대적인 방식입니다.</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// IBL 생성 (조명 데이터 + 배경 텍스처 생성됨)</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> skybox</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Display.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">SkyBox</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, ibl.environmentTexture);</span></span></code></pre></div><h3 id="_2-2-단일-hdr-이미지-hdrtexture" tabindex="-1">2.2 단일 HDR 이미지 (HDRTexture) <a class="header-anchor" href="#_2-2-단일-hdr-이미지-hdrtexture" aria-label="Permalink to &quot;2.2 단일 HDR 이미지 (HDRTexture)&quot;">​</a></h3><p>한 장의 HDR 파노라마 이미지를 로드하여 <code>HDRTexture</code>를 생성하고 이를 Skybox에 직접 적용하는 방식입니다.</p><ul><li><strong>장점</strong>: 단 한 장의 이미지로 고품질의 배경을 구성할 수 있습니다.</li><li><strong>특징</strong>: 단순히 배경으로만 사용되며, 씬 전체의 조명(IBL) 데이터까지 자동으로 계산하지는 않습니다.</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> hdrTexture</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Resource.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">HDRTexture</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    redGPUContext, </span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    &#39;/RedGPU/examples/assets/hdr/2k/the_sky_is_on_fire_2k.hdr&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> skybox</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Display.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">SkyBox</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, hdrTexture);</span></span></code></pre></div><h3 id="_2-3-6장의-이미지-cubetexture" tabindex="-1">2.3 6장의 이미지 (CubeTexture) <a class="header-anchor" href="#_2-3-6장의-이미지-cubetexture" aria-label="Permalink to &quot;2.3 6장의 이미지 (CubeTexture)&quot;">​</a></h3><p>상, 하, 좌, 우, 앞, 뒤 6장의 일반 이미지(JPG, PNG 등)를 결합하여 <code>CubeTexture</code>를 생성하는 고전적인 방식입니다. 이미지 배열은 반드시 <strong>px, nx, py, ny, pz, nz</strong> 순서로 전달해야 합니다.</p><ul><li><strong>장점</strong>: 리소스를 구하기 쉽고 직관적입니다.</li><li><strong>단점</strong>: HDR 정보를 포함하지 않아 사실적인 광원 효과를 기대하기 어렵습니다.</li></ul><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> cubeTexture</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Resource.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">CubeTexture</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, [</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]);</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> skybox</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Display.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">SkyBox</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, cubeTexture);</span></span></code></pre></div><h2 id="_3-구현-방식-비교" tabindex="-1">3. 구현 방식 비교 <a class="header-anchor" href="#_3-구현-방식-비교" aria-label="Permalink to &quot;3. 구현 방식 비교&quot;">​</a></h2><table tabindex="0"><thead><tr><th style="text-align:left;">구분</th><th style="text-align:left;">IBL 활용 (권장)</th><th style="text-align:left;">HDRTexture</th><th style="text-align:left;">CubeTexture</th></tr></thead><tbody><tr><td style="text-align:left;"><strong>소스</strong></td><td style="text-align:left;">1장의 HDR 이미지</td><td style="text-align:left;">1장의 HDR 이미지</td><td style="text-align:left;">6장의 이미지</td></tr><tr><td style="text-align:left;"><strong>타입</strong></td><td style="text-align:left;"><code>CubeTexture</code> (변환됨)</td><td style="text-align:left;"><code>HDRTexture</code></td><td style="text-align:left;"><code>CubeTexture</code></td></tr><tr><td style="text-align:left;"><strong>조명 데이터</strong></td><td style="text-align:left;">O (자동 생성)</td><td style="text-align:left;">X</td><td style="text-align:left;">X</td></tr><tr><td style="text-align:left;"><strong>주요 용도</strong></td><td style="text-align:left;">배경 + 물리 기반 조명</td><td style="text-align:left;">고품질 배경</td><td style="text-align:left;">단순 배경</td></tr></tbody></table><h2 id="_4-라이브-데모" tabindex="-1">4. 라이브 데모 <a class="header-anchor" href="#_4-라이브-데모" aria-label="Permalink to &quot;4. 라이브 데모&quot;">​</a></h2><h3 id="a-ibl-활용-방식-조명-포함" tabindex="-1">A. IBL 활용 방식 (조명 포함) <a class="header-anchor" href="#a-ibl-활용-방식-조명-포함" aria-label="Permalink to &quot;A. IBL 활용 방식 (조명 포함)&quot;">​</a></h3>`,16)),i(n,null,{default:a(()=>[i(h,{title:"RedGPU Basics - Skybox (IBL)",slugHash:"skybox-ibl"},{default:a(()=>[...e[0]||(e[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
