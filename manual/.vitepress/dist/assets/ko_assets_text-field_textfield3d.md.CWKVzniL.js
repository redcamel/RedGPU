import{f as p,D as n,c as d,o as r,a2 as e,H as t,w as l,k as s,a}from"./chunks/framework.cYGcyyTy.js";const D=JSON.parse('{"title":"TextField3D","description":"","frontmatter":{"title":"TextField3D","order":3},"headers":[],"relativePath":"ko/assets/text-field/textfield3d.md","filePath":"ko/assets/text-field/textfield3d.md","lastUpdated":1769498413000}'),E={name:"ko/assets/text-field/textfield3d.md"};function o(g,i,c,y,F,u){const h=n("CodePen"),k=n("ClientOnly");return r(),d("div",null,[i[1]||(i[1]=e(`<h1 id="textfield3d" tabindex="-1">TextField3D <a class="header-anchor" href="#textfield3d" aria-label="Permalink to &quot;TextField3D&quot;">​</a></h1><p><strong>TextField3D</strong> 는 3D 공간 상의 실제 좌표(<code>x, y, z</code>)에 배치되는 텍스트 객체입니다. 월드 내의 표지판, 캐릭터 머리 위의 이름표, 또는 특정 객체에 부착된 설명문 등을 만들 때 유용합니다.</p><h2 id="_1-기본-사용법" tabindex="-1">1. 기본 사용법 <a class="header-anchor" href="#_1-기본-사용법" aria-label="Permalink to &quot;1. 기본 사용법&quot;">​</a></h2><p><code>TextField3D</code> 는 일반적인 <strong>Mesh</strong> 와 동일하게 다루어지며, 3D 공간 내에 물리적으로 위치합니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> textField</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Display.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">TextField3D</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;3D World Text&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
