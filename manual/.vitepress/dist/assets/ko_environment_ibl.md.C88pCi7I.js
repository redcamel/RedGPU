import{D as i,c as h,o as k,k as e,H as s,a2 as l,a as n,w as t}from"./chunks/framework.cYGcyyTy.js";const m=JSON.parse('{"title":"IBL","description":"","frontmatter":{"order":2},"headers":[],"relativePath":"ko/environment/ibl.md","filePath":"ko/environment/ibl.md","lastUpdated":1769496586000}'),c={name:"ko/environment/ibl.md"},x=Object.assign(c,{setup(u){const o=`
...
`;return(b,a)=>{const d=i("MermaidResponsive"),r=i("ClientOnly"),p=i("CodePen");return k(),h("div",null,[a[1]||(a[1]=e("h1",{id:"ibl",tabindex:"-1"},[n("IBL "),e("a",{class:"header-anchor",href:"#ibl","aria-label":'Permalink to "IBL"'},"​")],-1)),a[2]||(a[2]=e("p",null,"IBL은 주변 환경의 이미지를 광원으로 사용하여 물체를 비추는 방식입니다. 단순한 광원만으로는 표현하기 힘든 사실적인 반사와 전역 조명 효과를 제공하여 3D 씬의 사실감을 극대화합니다.",-1)),a[3]||(a[3]=e("h2",{id:"_1-ibl의-핵심-구성",tabindex:"-1"},[n("1. IBL의 핵심 구성 "),e("a",{class:"header-anchor",href:"#_1-ibl의-핵심-구성","aria-label":'Permalink to "1. IBL의 핵심 구성"'},"​")],-1)),a[4]||(a[4]=e("p",null,[n("RedGPU의 "),e("strong",null,"이미지 기반 조명"),n("(IBL) 시스템은 HDR 환경 맵 또는 큐브맵 이미지를 분석하여 다음 세 가지 핵심 리소스를 자동으로 생성합니다.")],-1)),s(r,null,{default:t(()=>[s(d,{definition:o})]),_:1}),a[5]||(a[5]=l(`<h3 id="_1-1-방사-조도-텍스처-irradiance-texture" tabindex="-1">1.1 방사 조도 텍스처 (Irradiance Texture) <a class="header-anchor" href="#_1-1-방사-조도-텍스처-irradiance-texture" aria-label="Permalink to &quot;1.1 방사 조도 텍스처 (Irradiance Texture)&quot;">​</a></h3><p>물체의 기본 명암과 주변광(Ambient) 역할을 하며, 직접적인 광원이 없는 곳에서도 자연스러운 색감을 부여합니다.</p><h3 id="_1-2-ibl-텍스처-specular-texture" tabindex="-1">1.2 IBL 텍스처 (Specular Texture) <a class="header-anchor" href="#_1-2-ibl-텍스처-specular-texture" aria-label="Permalink to &quot;1.2 IBL 텍스처 (Specular Texture)&quot;">​</a></h3><p>물체 표면에 주변 환경이 비치는 효과를 담당합니다. 물리 기반 렌더링(PBR) 재질에서 금속이나 유리 같은 표면의 반사를 표현합니다.</p><h3 id="_1-3-환경-텍스처-environment-texture" tabindex="-1">1.3 환경 텍스처 (Environment Texture) <a class="header-anchor" href="#_1-3-환경-텍스처-environment-texture" aria-label="Permalink to &quot;1.3 환경 텍스처 (Environment Texture)&quot;">​</a></h3><p>원본 이미지를 고해상도 큐브맵으로 유지한 데이터로, 주로 <strong>SkyBox</strong> 의 배경 텍스처로 사용됩니다.</p><h2 id="_2-구현하기-생성-및-적용" tabindex="-1">2. 구현하기: 생성 및 적용 <a class="header-anchor" href="#_2-구현하기-생성-및-적용" aria-label="Permalink to &quot;2. 구현하기: 생성 및 적용&quot;">​</a></h2><p>IBL을 적용하려면 리소스를 생성한 후, 카메라 뷰(<strong>View3D</strong>)에 등록해야 합니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. IBL 리소스 생성 (HDR 파일 권장)</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">view.skybox </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.Display.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">SkyBox</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(redGPUContext, ibl.environmentTexture);</span></span></code></pre></div><h2 id="_3-라이브-샘플-환경-구성" tabindex="-1">3. 라이브 샘플: 환경 구성 <a class="header-anchor" href="#_3-라이브-샘플-환경-구성" aria-label="Permalink to &quot;3. 라이브 샘플: 환경 구성&quot;">​</a></h2><p>아래 예제는 HDR 소스로부터 IBL과 Skybox를 동시에 생성한 결과입니다. 지금은 단순히 360도 배경이 보일 뿐이지만, 이 공간은 이미 물리적으로 정확한 빛의 데이터를 머금고 있는 상태입니다.</p>`,11)),s(r,null,{default:t(()=>[s(p,{title:"RedGPU Basics - Environmental Setup",slugHash:"env-setup"},{default:t(()=>[...a[0]||(a[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
