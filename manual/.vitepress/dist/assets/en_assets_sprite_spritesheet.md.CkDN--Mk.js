...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">scene.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">addChild</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(spriteSheet);</span></span></code></pre></div><h2 id="_3-animation-control" tabindex="-1">3. Animation Control <a class="header-anchor" href="#_3-animation-control" aria-label="Permalink to &quot;3. Animation Control&quot;">​</a></h2><p>You can control the playback state of the animation in real-time through the <code>SpriteSheet3D</code> instance.</p><ul><li><strong><code>play()</code></strong>: Starts the animation.</li><li><strong><code>stop()</code></strong>: Pauses the animation at the current frame.</li><li><strong><code>gotoAndPlay(frameIndex)</code></strong>: Moves to the specified frame and plays immediately.</li><li><strong><code>gotoAndStop(frameIndex)</code></strong>: Moves to the specified frame and stops.</li></ul><h2 id="_4-practical-example-walking-character-animation" tabindex="-1">4. Practical Example: Walking Character Animation <a class="header-anchor" href="#_4-practical-example-walking-character-animation" aria-label="Permalink to &quot;4. Practical Example: Walking Character Animation&quot;">​</a></h2><p>See how a grid-type sheet image transforms into a natural character motion through <code>SpriteSheet3D</code> and <strong>Billboard</strong> settings.</p>`,13)),n(h,null,{default:l(()=>[n(r,{title:"RedGPU - SpriteSheet3D Animation",slugHash:"spritesheet3d-basic"},{default:l(()=>[...s[0]||(s[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),i(`
`),e("p",null,"});"),i(`
`)],-1)])]),_:1})]),_:1}),s[2]||(s[2]=a('<hr><h2 id="key-summary" tabindex="-1">Key Summary <a class="header-anchor" href="#key-summary" aria-label="Permalink to &quot;Key Summary&quot;">​</a></h2><ul><li><strong>SpriteSheetInfo</strong>: Defines image source, sheet grid structure (Segments), animation speed (FPS), etc.</li><li><strong>Animation Control</strong>: Control visual flow through methods like <code>play</code>, <code>stop</code>, <code>gotoAndPlay</code>.</li><li><strong>Efficiency</strong>: Beneficial in terms of network overhead and GPU memory management by using a single sheet file instead of loading multiple images individually.</li></ul>',3))])}const C=p(c,[["render",k]]);export{E as __pageData,C as default};
