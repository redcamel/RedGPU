...
`)]),a(`
`),s("p",null,"});"),a(`
`)],-1)])]),_:1})]),_:1}),i[2]||(i[2]=s("h2",{id:"next-steps",tabindex:"-1"},[a("Next Steps "),s("a",{class:"header-anchor",href:"#next-steps","aria-label":'Permalink to "Next Steps"'},"​")],-1)),i[3]||(i[3]=s("p",null,"Learn about image-based objects that will enrich the 3D space alongside text.",-1)),i[4]||(i[4]=s("ul",null,[s("li",null,[s("strong",null,[s("a",{href:"./../sprite/"},"Sprite")])])],-1))])}const P=p(o,[["render",g]]);export{C as __pageData,P as default};
