...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><h3 id="_2-2-key-features" tabindex="-1">2.2 Key Features <a class="header-anchor" href="#_2-2-key-features" aria-label="Permalink to &quot;2.2 Key Features&quot;">​</a></h3><ul><li><strong>Real-time State Management</strong>: Integrated management is provided within <code>redGPUContext</code>, eliminating the need to directly manage separate <code>keydown</code> and <code>keyup</code> listeners.</li><li><strong>Case Sensitivity</strong>: Since it uses the <code>e.key</code> value directly, it is case-sensitive. For universal input, it is recommended to check both <code>&#39;w&#39;</code> and <code>&#39;W&#39;</code>.</li><li><strong>Modifier Key Support</strong>: The state of special keys such as <code>Shift</code>, <code>Control</code>, and <code>Alt</code> can be checked in the same way.</li></ul><h2 id="_3-live-examples" tabindex="-1">3. Live Examples <a class="header-anchor" href="#_3-live-examples" aria-label="Permalink to &quot;3. Live Examples&quot;">​</a></h2><p>You can directly explore various interaction behaviors provided by RedGPU through the examples below.</p><h3 id="_3-1-mouse-and-touch-examples" tabindex="-1">3.1 Mouse and Touch Examples <a class="header-anchor" href="#_3-1-mouse-and-touch-examples" aria-label="Permalink to &quot;3.1 Mouse and Touch Examples&quot;">​</a></h3><ul><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/mouseEvent/mesh/" target="_blank" rel="noreferrer">Basic Mesh Interaction</a></li><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/mouseEvent/sprite3D/" target="_blank" rel="noreferrer">Sprite Interaction</a></li><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/mouseEvent/spriteSheet3D/" target="_blank" rel="noreferrer">Sprite Sheet Interaction</a></li><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/mouseEvent/textField3D/" target="_blank" rel="noreferrer">Text Field Interaction</a></li><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/mouseEvent/raycasting/" target="_blank" rel="noreferrer">High-Precision Raycasting (Raycasting)</a></li></ul><h3 id="_3-2-keyboard-interaction-examples" tabindex="-1">3.2 Keyboard Interaction Examples <a class="header-anchor" href="#_3-2-keyboard-interaction-examples" aria-label="Permalink to &quot;3.2 Keyboard Interaction Examples&quot;">​</a></h3><ul><li><a href="https://redcamel.github.io/RedGPU/examples/3d/interaction/keyboardEvent/" target="_blank" rel="noreferrer">Keyboard Interaction 3D Example</a></li><li><a href="https://redcamel.github.io/RedGPU/examples/2d/interaction/keyboardEvent/" target="_blank" rel="noreferrer">Keyboard Interaction 2D Example</a></li></ul><h2 id="_4-key-summary" tabindex="-1">4. Key Summary <a class="header-anchor" href="#_4-key-summary" aria-label="Permalink to &quot;4. Key Summary&quot;">​</a></h2><ul><li>Independent event processing for each object is possible through <code>addListener</code>.</li><li>Precise, frame-by-frame keyboard state control is possible through <code>keyboardKeyBuffer</code>.</li><li>A rich user experience (UX) can be provided by using these alongside the web-standard DOM API.</li></ul><h2 id="_5-next-learning-recommendation" tabindex="-1">5. Next Learning Recommendation <a class="header-anchor" href="#_5-next-learning-recommendation" aria-label="Permalink to &quot;5. Next Learning Recommendation&quot;">​</a></h2><p>Apply post-processing effects that enhance the visual completion of scenes enriched with interaction.</p><ul><li><strong><a href="./../post-effect/">Post-Effect</a></strong></li></ul>`,18))])}const b=d(p,[["render",k]]);export{x as __pageData,b as default};
