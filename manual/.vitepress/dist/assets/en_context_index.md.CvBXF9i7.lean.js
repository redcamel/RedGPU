import{$ as t,Q as o,j as r,m as a,o as s,ax as d}from"./chunks/framework.DRwqO8Wa.js";const k=JSON.parse('{"title":"RedGPU Context","description":"Learn about RedGPUContext, the starting point and resource manager of the RedGPU engine.","frontmatter":{"title":"RedGPU Context","description":"Learn about RedGPUContext, the starting point and resource manager of the RedGPU engine.","order":2},"headers":[],"relativePath":"en/context/index.md","filePath":"en/context/index.md","lastUpdated":1783322521000}'),c={name:"en/context/index.md"},y=Object.assign(c,{setup(h){const i=`
    graph LR
