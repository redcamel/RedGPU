import{c as d,$ as t,Q as h,j as c,m as i,o as s,ax as r,g as e,n as a}from"./chunks/framework.D5MFXpji.js";const f=JSON.parse('{"title":"FXAA","description":"","frontmatter":{"title":"FXAA","order":3},"headers":[],"relativePath":"en/antialiasing/fxaa.md","filePath":"en/antialiasing/fxaa.md","lastUpdated":1781144716000}'),g={name:"en/antialiasing/fxaa.md"};function p(u,n,m,x,A,P){const o=t("CodePen"),l=t("ClientOnly");return h(),c("div",null,[n[1]||(n[1]=i(`<h1 id="fxaa-fast-approximate-aa" tabindex="-1">FXAA (Fast Approximate AA) <a class="header-anchor" href="#fxaa-fast-approximate-aa" aria-label="Permalink to &quot;FXAA (Fast Approximate AA)&quot;">​</a></h1><p><strong>FXAA</strong> is a <strong>post-processing</strong> (Post-Processing) antialiasing technique that analyzes the rendered image to find edges and smooth them.</p><h2 id="_1-features-pros" tabindex="-1">1. Features &amp; Pros <a class="header-anchor" href="#_1-features-pros" aria-label="Permalink to &quot;1. Features &amp; Pros&quot;">​</a></h2><ul><li><strong>Ultra-Fast</strong>: Very low computational cost, making it ideal for mobile devices and low-end hardware.</li><li><strong>Memory Efficient</strong>: Does not require additional buffers like MSAA.</li><li><strong>Cons</strong>: The entire screen may appear slightly blurry, which can reduce texture sharpness.</li></ul><h2 id="_2-usage" tabindex="-1">2. Usage <a class="header-anchor" href="#_2-usage" aria-label="Permalink to &quot;2. Usage&quot;">​</a></h2><p>Enabled via <code>antialiasingManager.useFXAA</code>. Enabling this automatically disables MSAA or TAA.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Enable FXAA (Other AAs are disabled)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">redGPUContext.antialiasingManager.useFXAA </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> true</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><h2 id="_3-live-example-fxaa-quality-check" tabindex="-1">3. Live Example: FXAA Quality Check <a class="header-anchor" href="#_3-live-example-fxaa-quality-check" aria-label="Permalink to &quot;3. Live Example: FXAA Quality Check&quot;">​</a></h2><p>Observe how FXAA handles not only geometry edges but also shimmering in textures and highlights.</p>`,9)),s(l,null,{default:r(()=>[s(o,{title:"RedGPU - FXAA Example",slugHash:"antialiasing-fxaa"},{default:r(()=>[...n[0]||(n[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
