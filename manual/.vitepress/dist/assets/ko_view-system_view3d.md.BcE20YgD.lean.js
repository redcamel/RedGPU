import{D as p,o,c as g,a2 as l,G as n,w as e,k as s,a}from"./chunks/framework.DpNgdNqH.js";const m=JSON.parse('{"title":"View3D","description":"RedGPU의 렌더링 단위인 View3D의 기술적 명세와 사용법을 다룹니다.","frontmatter":{"title":"View3D","description":"RedGPU의 렌더링 단위인 View3D의 기술적 명세와 사용법을 다룹니다.","order":2},"headers":[],"relativePath":"ko/view-system/view3d.md","filePath":"ko/view-system/view3d.md","lastUpdated":1770625747000}'),c={name:"ko/view-system/view3d.md"},w=Object.assign(c,{setup(y){const r=`
    graph TD
...
`;return(C,i)=>{const h=p("MermaidResponsive"),t=p("ClientOnly"),k=p("CodePen");return o(),g("div",null,[i[2]||(i[2]=l("",4)),n(t,null,{default:e(()=>[n(h,{definition:r})]),_:1}),i[3]||(i[3]=l("",7)),n(t,null,{default:e(()=>[n(k,{title:"RedGPU Basics - View3D",slugHash:"view-basic"},{default:e(()=>[...i[0]||(i[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),a(`
`),s("p",null,"});"),a(`
`)],-1)])]),_:1})]),_:1}),i[4]||(i[4]=l("",15)),n(t,null,{default:e(()=>[n(h,{definition:E})]),_:1}),i[5]||(i[5]=l("",3)),n(t,null,{default:e(()=>[n(k,{title:"RedGPU Basics - Multi View",slugHash:"view-multi"},{default:e(()=>[...i[1]||(i[1]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
`,-1),s("pre",{"data-lang":"css"},`body { margin: 0; overflow: hidden; background: #111; }
canvas { display: block; width: 100vw; height: 100vh; }
`,-1),s("pre",{"data-lang":"js"},[a(`import * as RedGPU from "https://redcamel.github.io/RedGPU/dist/index.js";
`),s("p",null,'const canvas = document.getElementById("redgpu-canvas");'),a(`
