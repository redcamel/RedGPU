import{c as k,$ as n,Q as p,j as r,m as d,o as h,ax as t,g as s,n as a}from"./chunks/framework.D5MFXpji.js";const D=JSON.parse('{"title":"Camera","description":"","frontmatter":{"title":"Camera","order":4},"headers":[],"relativePath":"ko/view-system/camera.md","filePath":"ko/view-system/camera.md","lastUpdated":1784264306000}'),E={name:"ko/view-system/camera.md"};function g(o,i,y,c,F,C){const e=n("CodePen"),l=n("ClientOnly");return p(),r("div",null,[i[1]||(i[1]=d("",19)),h(l,null,{default:t(()=>[h(e,{title:"RedGPU Basics - Camera lookAt",slugHash:"camera-lookat"},{default:t(()=>[...i[0]||(i[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),a(`
`),s("p",null,"});"),a(`
`)],-1)])]),_:1})]),_:1}),i[2]||(i[2]=s("hr",null,null,-1)),i[3]||(i[3]=s("h2",{id:"다음-단계",tabindex:"-1"},[a("다음 단계 "),s("a",{class:"header-anchor",href:"#다음-단계","aria-label":'Permalink to "다음 단계"'},"​")],-1)),i[4]||(i[4]=s("p",null,"카메라의 위치를 코드로 일일이 계산하는 대신, 마우스와 터치를 이용해 직관적으로 조종하는 방법을 알아봅니다.",-1)),i[5]||(i[5]=s("ul",null,[s("li",null,[s("strong",null,[s("a",{href:"./controller.html"},"카메라 컨트롤러")])])],-1))])}const A=k(E,[["render",g]]);export{D as __pageData,A as default};
