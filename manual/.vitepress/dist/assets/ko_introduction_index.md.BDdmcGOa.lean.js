import{D as l,c as E,o as g,a2 as h,H as n,k as i,w as t,a}from"./chunks/framework.cYGcyyTy.js";const C=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{"title":"Getting Started","order":1},"headers":[],"relativePath":"ko/introduction/index.md","filePath":"ko/introduction/index.md","lastUpdated":1769498891000}'),o={name:"ko/introduction/index.md"},m=Object.assign(o,{setup(y){const p=`
...
`,r=`
    ...
    Render --> Update
`;return(c,s)=>{const d=l("CodePen"),e=l("ClientOnly"),k=l("MermaidResponsive");return g(),E("div",null,[s[1]||(s[1]=h("",19)),n(e,null,{default:t(()=>[n(d,{title:"RedGPU Quick Start - Rotating Cube",slugHash:"getting-started"},{default:t(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
