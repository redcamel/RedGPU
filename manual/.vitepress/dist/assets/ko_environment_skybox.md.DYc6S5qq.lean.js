...
`;return(y,e)=>{const p=l("MermaidResponsive"),n=l("ClientOnly"),h=l("CodePen");return o(),k("div",null,[e[2]||(e[2]=r("",7)),i(n,null,{default:a(()=>[i(p,{definition:d})]),_:1}),e[3]||(e[3]=r("",16)),i(n,null,{default:a(()=>[i(h,{title:"RedGPU Basics - Skybox (IBL)",slugHash:"skybox-ibl"},{default:a(()=>[...e[0]||(e[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
