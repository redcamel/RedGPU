import{D as n,o as g,c as d,a2 as h,G as t,w as e,k as i,a}from"./chunks/framework.DpNgdNqH.js";const F=JSON.parse('{"title":"Light","description":"","frontmatter":{"title":"Light","order":2},"headers":[],"relativePath":"en/lighting-and-shadow/light.md","filePath":"en/lighting-and-shadow/light.md","lastUpdated":1770635218000}'),o={name:"en/lighting-and-shadow/light.md"},C=Object.assign(o,{setup(E){const k=`
    graph TD
        Scene["Scene (Stage)"]
...
`;return(y,s)=>{const p=n("MermaidResponsive"),l=n("ClientOnly"),r=n("CodePen");return g(),d("div",null,[s[1]||(s[1]=h("",4)),t(l,null,{default:e(()=>[t(p,{definition:k})]),_:1}),s[2]||(s[2]=h("",23)),t(l,null,{default:e(()=>[t(r,{title:"RedGPU Basics - Multi Lights",slugHash:"multi-lights-demo"},{default:e(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
