import{D as e,c as d,o,a2 as t,H as n,w as h,k as i,a}from"./chunks/framework.cYGcyyTy.js";const F=JSON.parse('{"title":"Scene","description":"","frontmatter":{"title":"Scene","order":3},"headers":[],"relativePath":"en/view-system/scene.md","filePath":"en/view-system/scene.md","lastUpdated":1769498891000}'),g={name:"en/view-system/scene.md"},C=Object.assign(g,{setup(c){const p=`
    graph TD
...
`;return(E,s)=>{const k=e("MermaidResponsive"),l=e("ClientOnly"),r=e("CodePen");return o(),d("div",null,[s[1]||(s[1]=t("",4)),n(l,null,{default:h(()=>[n(k,{definition:p})]),_:1}),s[2]||(s[2]=t("",12)),n(l,null,{default:h(()=>[n(r,{title:"RedGPU Basics - Scene Complete",slugHash:"scene-complete"},{default:h(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
