...
const manualSidebarConfigs = languages.map(lang => ({
    ...
    sortMenusByFrontmatterOrder: true,
        // 폴더 및 파일 정렬 순서 지정
        manualSortFileNameByPriority: ['introduction', 'context', 'view-system', 'basic-objects', 'shadow-system', 'environment', 'model-loading', 'post-effect', 'text-field', 'sprite', 'interaction']
    }));
