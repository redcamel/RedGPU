...
[RedGPU API](../../../../../../../README.md) / [RedGPU](../../../../README.md) / [Math](../../README.md) / quat

# quat

## Variables

- [exactEquals](variables/exactEquals.md)
- [length](variables/length.md)

## Functions

- [add](functions/add.md)
- [calculateW](functions/calculateW.md)
...
- [fromEuler](functions/fromEuler.md)
- [fromMat3](functions/fromMat3.md)
- [fromValues](functions/fromValues.md)
- [getAngle](functions/getAngle.md)
- [getAxisAngle](functions/getAxisAngle.md)
...
- [rotationTo](functions/rotationTo.md)
- [scale](functions/scale.md)
- [set](functions/set.md)
- [setAxes](functions/setAxes.md)
- [setAxisAngle](functions/setAxisAngle.md)
- [slerp](functions/slerp.md)
- [sqlerp](functions/sqlerp.md)
