...
Defined in: [src/defineProperty/funcs/texture/defineCubeTexture.ts:74](https://github.com/redcamel/RedGPU/blob/302ea63caf5f5ecf51af7f70ca3a0940bde79a48/src/defineProperty/funcs/texture/defineCubeTexture.ts#L74)
...
- If a corresponding `use{Key}` property (e.g. `useEnvMap`) exists on the target, it automatically synchronizes its boolean state and GPU globalStruct value (1 or 0) based on texture presence.
