...
[RedGPU API](../../../../../../../../README.md) / [RedGPU](../../../../../README.md) / [ShaderLibrary](../../../README.md) / [color](../README.md) / getTintBlendMode

# Variable: getTintBlendMode

> `const` **getTintBlendMode**: `string` = `getTintBlendMode_wgsl`

Defined in: [src/systemCodeManager/ShaderLibrary.ts:1393](https://github.com/redcamel/RedGPU/blob/302ea63caf5f5ecf51af7f70ca3a0940bde79a48/src/systemCodeManager/ShaderLibrary.ts#L1393)
...
/**
 * Blends the base color with a tint color using the specified blending mode.
 *
 * @param baseColor Base color (RGBA)
 * @param tintBlendMode Blending mode index (0: NORMAL, 1: MULTIPLY, ... 22: NEGATION)
 * @param tint Tint color to blend (RGBA)
 * @returns Final blended color (RGBA)
 *
 */
