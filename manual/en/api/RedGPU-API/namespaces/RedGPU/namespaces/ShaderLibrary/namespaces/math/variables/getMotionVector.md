...
[RedGPU API](../../../../../../../../README.md) / [RedGPU](../../../../../README.md) / [ShaderLibrary](../../../README.md) / [math](../README.md) / getMotionVector

# Variable: getMotionVector

> `const` **getMotionVector**: `string` = `getMotionVector_wgsl`

Defined in: [src/systemCodeManager/ShaderLibrary.ts:442](https://github.com/redcamel/RedGPU/blob/d8e9f05bb1256579c84cecea5c335fe1722c97f6/src/systemCodeManager/ShaderLibrary.ts#L442)

Calculates the motion vector (in UV units) by comparing current and previous clip space coordinates.

//

## Param

Current frame's clip space position
//

## Param

Previous frame's clip space position
//

## Returns

Motion vector in UV space (vec2)
