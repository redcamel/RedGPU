...
Defined in: [src/display/textFields/core/ATextField.ts:16](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/textFields/core/ATextField.ts#L16)
...
Defined in: [src/display/textFields/core/ATextField.ts:175](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/textFields/core/ATextField.ts#L175)

Creates a new ATextField instance.
...
| `imgOnload` | `Function` | `undefined` | Callback function for syncing width/height resolution after image creation is complete |
| `mode3dYn` | `boolean` | `true` | Whether to generate as a texture for 3D space (linear filter applied) |
...
Defined in: [src/display/mesh/Mesh.ts:101](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/mesh/Mesh.ts#L101)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `renderViewStateData` | [`RenderViewStateData`](../../CoreView/classes/RenderViewStateData.md) | Current render view state data |
