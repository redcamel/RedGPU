...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:72](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L72)

High-performance mesh class based on GPU instancing.

Enables rendering a large number of meshes that share a single Geometry and Material using a single draw call. Each instance (InstancingMeshObject3D) has independent position, rotation, scale, and opacity properties, with frustum culling and Level of Detail (LOD) processed efficiently via GPU compute operations.
...
Below is a list of additional sample examples to help understand the structure and operation of InstancingMesh.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:143](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L143)
...
| `maxInstanceCount` | `number` | The maximum limit of instances that can be created and uploaded |
| `instanceCount` | `number` | Initial active instance count |
...
| `material?` | `any` | Material to apply (optional) |
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:77](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L77)

Whether individual instance data is dirty and the GPU buffer needs to be updated.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:82](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L82)

Whether the active instance count information has been modified.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:205](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L205)

Gets the array of child objects (InstancingMeshObject3D) to control the transform details of each instance.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:174](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L174)

Gets or sets the number of active instances to render. Individual instance controllers (InstancingMeshObject3D) are automatically created and updated internally based on the value.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:178](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L178)
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:197](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L197)

Gets the maximum allowed instance count for this instanced mesh.
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:258](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L258)

Records the instanced mesh into the rendering queue. Rebuilds resources when LOD is dirty, and performs frustum culling via GPU compute shaders if not in shadow rendering mode.
...
| `shadowRender` | `boolean` | `false` | Whether it is for the shadow map generation pass (default: false) |
...
Defined in: [src/display/instancingMesh/InstancingMesh.ts:219](https://github.com/redcamel/RedGPU/blob/a734ff9f69c2580cada1bff993a61d03dd359f8b/src/display/instancingMesh/InstancingMesh.ts#L219)

Computes the maximum theoretical instance count that can be uploaded based on the current GPU Context's limits (maxStorageBufferBindingSize).
...
Hardware-constrained maximum instance count
