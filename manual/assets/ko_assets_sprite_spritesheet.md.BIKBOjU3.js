...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">spriteSheet.pixelSize </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 128</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><h3 id="_3-3-크기-설정-정책" tabindex="-1">3.3 크기 설정 정책 <a class="header-anchor" href="#_3-3-크기-설정-정책" aria-label="Permalink to &quot;3.3 크기 설정 정책&quot;">​</a></h3><p><code>SpriteSheet3D</code>는 <code>Sprite3D</code>와 동일한 크기 설정 메커니즘을 공유합니다. <code>worldSize</code>를 통한 3D 공간 내 물리 크기 설정과 <code>usePixelSize</code>를 통한 화면상 절대 픽셀 크기 설정을 지원합니다.</p><p>상세한 모드별 차이점과 작동 원리는 **<a href="./sprite.html#_3-3-월드-사이즈와-픽셀-사이즈의-관계">Sprite3D 매뉴얼의 크기 관계 섹션</a>**을 참조하십시오.</p><h2 id="_4-실습-예제-걷는-캐릭터-애니메이션" tabindex="-1">4. 실습 예제: 걷는 캐릭터 애니메이션 <a class="header-anchor" href="#_4-실습-예제-걷는-캐릭터-애니메이션" aria-label="Permalink to &quot;4. 실습 예제: 걷는 캐릭터 애니메이션&quot;">​</a></h2><p>격자 형태의 시트 이미지가 <code>SpriteSheet3D</code> 와 <strong>Billboard</strong> 설정을 통해 어떻게 자연스러운 캐릭터 동작으로 변하는지 확인해 봅니다.</p>`,23)),n(r,null,{default:l(()=>[n(h,{title:"RedGPU - SpriteSheet3D Animation",slugHash:"spritesheet3d-basic"},{default:l(()=>[...t[0]||(t[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),s(`
`),e("p",null,"});"),s(`
`)],-1)])]),_:1})]),_:1}),t[2]||(t[2]=a('<hr><h2 id="핵심-요약" tabindex="-1">핵심 요약 <a class="header-anchor" href="#핵심-요약" aria-label="Permalink to &quot;핵심 요약&quot;">​</a></h2><ul><li><strong>SpriteSheetInfo</strong> : 이미지 소스와 시트의 격자 구조(Segments), 애니메이션 속도(FPS) 등을 정의합니다.</li><li><strong>애니메이션 제어</strong>: <code>play</code>, <code>stop</code>, <code>gotoAndPlay</code> 등의 메서드를 통해 시각적 흐름을 제어합니다.</li><li><strong>효율성</strong>: 여러 장의 이미지를 각각 불러오는 대신 하나의 시트 파일을 사용하므로 네트워크 오버헤드와 GPU 메모리 관리 측면에서 유리합니다.</li></ul><hr><h2 id="다음-학습-추천" tabindex="-1">다음 학습 추천 <a class="header-anchor" href="#다음-학습-추천" aria-label="Permalink to &quot;다음 학습 추천&quot;">​</a></h2><p>3D 공간 내에 입체적인 텍스트 레이블을 구성하고 배치하는 방법에 대해 알아봅니다.</p><ul><li><strong><a href="./../text-field/textfield3d.html">TextField3D</a></strong></li></ul>',7))])}const f=d(k,[["render",c]]);export{b as __pageData,f as default};
