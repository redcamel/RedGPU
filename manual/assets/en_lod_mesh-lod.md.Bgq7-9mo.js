import{f as r,D as a,c as d,o as p,a2 as o,H as n,w as t,k as e,a as s}from"./chunks/framework.cYGcyyTy.js";const x=JSON.parse('{"title":"Mesh LOD","description":"","frontmatter":{"title":"Mesh LOD","order":2},"headers":[],"relativePath":"en/lod/mesh-lod.md","filePath":"en/lod/mesh-lod.md","lastUpdated":1769496586000}'),k={name:"en/lod/mesh-lod.md"};function c(g,i,E,m,y,u){const l=a("CodePen"),h=a("ClientOnly");return p(),d("div",null,[i[1]||(i[1]=o(`<h1 id="mesh-lod" tabindex="-1">Mesh LOD <a class="header-anchor" href="#mesh-lod" aria-label="Permalink to &quot;Mesh LOD&quot;">​</a></h1><p>This section covers how to apply LOD to general <strong>Mesh</strong> objects. LOD for a <code>Mesh</code> works by calculating the distance from the camera on the CPU every frame and swapping to the <strong>Geometry</strong> that meets the condition.</p><h2 id="_1-how-it-works" tabindex="-1">1. How it Works <a class="header-anchor" href="#_1-how-it-works" aria-label="Permalink to &quot;1. How it Works&quot;">​</a></h2><p>The <code>LODManager</code> inside the <code>Mesh</code> iterates through the registered LOD levels and finds the level with the largest distance value that is less than or equal to the current camera distance. When a suitable level is found, the rendering target is swapped to the geometry registered in that level.</p><h2 id="_2-usage" tabindex="-1">2. Usage <a class="header-anchor" href="#_2-usage" aria-label="Permalink to &quot;2. Usage&quot;">​</a></h2><p>Use <code>mesh.LODManager.addLOD(distance, geometry)</code> to register geometry by distance.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> *</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://redcamel.github.io/RedGPU/dist/index.js&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">scene.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">addChild</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(mesh);</span></span></code></pre></div><h2 id="_3-live-example" tabindex="-1">3. Live Example <a class="header-anchor" href="#_3-live-example" aria-label="Permalink to &quot;3. Live Example&quot;">​</a></h2><p>Observe how the sphere shape becomes simpler and eventually turns into a box as the distance increases.</p>`,9)),n(h,null,{default:t(()=>[n(l,{title:"RedGPU - Mesh LOD Example",slugHash:"lod-mesh-basic"},{default:t(()=>[...i[0]||(i[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
