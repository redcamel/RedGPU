import{$ as t,Q as d,j as o,m as s,o as i,ax as r}from"./chunks/framework.DRwqO8Wa.js";const g=JSON.parse('{"title":"RedGPU Context","description":"RedGPU 엔진의 시작점이자 리소스 관리자인 RedGPUContext에 대해 알아봅니다.","frontmatter":{"title":"RedGPU Context","description":"RedGPU 엔진의 시작점이자 리소스 관리자인 RedGPUContext에 대해 알아봅니다.","order":2},"headers":[],"relativePath":"ko/context/index.md","filePath":"ko/context/index.md","lastUpdated":1783322521000}'),h={name:"ko/context/index.md"},E=Object.assign(h,{setup(c){const a=`
    graph LR
