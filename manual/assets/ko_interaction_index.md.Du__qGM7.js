...
`)]),s(`
`),t("p",null,"});"),s(`
`)],-1)])]),_:1})]),_:1}),e[2]||(e[2]=n(`<h2 id="_2-키보드-인터렉션-keyboardkeybuffer" tabindex="-1">2. 키보드 인터렉션 (keyboardKeyBuffer) <a class="header-anchor" href="#_2-키보드-인터렉션-keyboardkeybuffer" aria-label="Permalink to &quot;2. 키보드 인터렉션 (keyboardKeyBuffer)&quot;">​</a></h2><p>객체 피킹 외에도, <code>redGPUContext.keyboardKeyBuffer</code>를 통해 키보드의 실시간 눌림 상태를 확인할 수 있습니다. 이는 캐릭터 이동, 카메라 컨트롤 등 매 프레임마다 키 상태를 체크해야 하는 로직에 매우 유용합니다.</p><h3 id="_2-1-기본-사용법" tabindex="-1">2.1 기본 사용법 <a class="header-anchor" href="#_2-1-기본-사용법" aria-label="Permalink to &quot;2.1 기본 사용법&quot;">​</a></h3><p><code>keyboardKeyBuffer</code>는 현재 눌려있는 키의 이름을 키(Key)로, 눌림 여부를 값(Value)으로 가지는 객체입니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">RedGPU.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">init</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(canvas, (</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">redGPUContext</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><h3 id="_2-2-주요-특징" tabindex="-1">2.2 주요 특징 <a class="header-anchor" href="#_2-2-주요-특징" aria-label="Permalink to &quot;2.2 주요 특징&quot;">​</a></h3><ul><li><strong>실시간 상태 관리</strong>: 별도의 <code>keydown</code>, <code>keyup</code> 리스너를 직접 관리할 필요 없이 <code>redGPUContext</code>에서 통합 관리됩니다.</li><li><strong>대소문자 구분</strong>: <code>e.key</code> 값을 그대로 사용하므로 대소문자를 구분합니다. 보편적인 입력을 위해서는 <code>&#39;w&#39;</code>와 <code>&#39;W&#39;</code>를 모두 체크하는 것이 좋습니다.</li><li><strong>조합 키 지원</strong>: <code>Shift</code>, <code>Control</code>, <code>Alt</code> 등의 특수 키 상태도 동일하게 확인할 수 있습니다.</li></ul><h2 id="_3-라이브-예제" tabindex="-1">3. 라이브 예제 <a class="header-anchor" href="#_3-라이브-예제" aria-label="Permalink to &quot;3. 라이브 예제&quot;">​</a></h2><p>RedGPU가 제공하는 다양한 인터렉션 동작을 아래 예제들을 통해 직접 확인할 수 있습니다.</p><h3 id="_3-1-마우스-및-터치-예제" tabindex="-1">3.1 마우스 및 터치 예제 <a class="header-anchor" href="#_3-1-마우스-및-터치-예제" aria-label="Permalink to &quot;3.1 마우스 및 터치 예제&quot;">​</a></h3><ul><li><a href="/RedGPU/examples/3d/interaction/mouseEvent/mesh/" target="_blank" rel="noopener noreferrer">일반 메시 인터렉션</a></li><li><a href="/RedGPU/examples/3d/interaction/mouseEvent/sprite3D/" target="_blank" rel="noopener noreferrer">스프라이트 인터렉션</a></li><li><a href="/RedGPU/examples/3d/interaction/mouseEvent/spriteSheet3D/" target="_blank" rel="noopener noreferrer">스프라이트 시트 인터렉션</a></li><li><a href="/RedGPU/examples/3d/interaction/mouseEvent/textField3D/" target="_blank" rel="noopener noreferrer">텍스트 필드 인터렉션</a></li><li><a href="/RedGPU/examples/3d/interaction/mouseEvent/raycasting/" target="_blank" rel="noopener noreferrer">고정밀 레이캐스팅 (Raycasting)</a></li></ul><h3 id="_3-2-키보드-인터렉션-예제" tabindex="-1">3.2 키보드 인터렉션 예제 <a class="header-anchor" href="#_3-2-키보드-인터렉션-예제" aria-label="Permalink to &quot;3.2 키보드 인터렉션 예제&quot;">​</a></h3><ul><li><a href="/RedGPU/examples/3d/interaction/keyboardEvent/" target="_blank" rel="noopener noreferrer">키보드 인터렉션 3D 예제</a></li><li><a href="/RedGPU/examples/2d/interaction/keyboardEvent/" target="_blank" rel="noopener noreferrer">키보드 인터렉션 2D 예제</a></li></ul><h2 id="_4-핵심-요약" tabindex="-1">4. 핵심 요약 <a class="header-anchor" href="#_4-핵심-요약" aria-label="Permalink to &quot;4. 핵심 요약&quot;">​</a></h2><ul><li><code>addListener</code> 를 통해 객체별로 독립적인 이벤트 처리가 가능합니다.</li><li><code>keyboardKeyBuffer</code> 를 통해 프레임 단위의 정밀한 키보드 상태 제어가 가능합니다.</li><li>웹 표준 DOM API와 함께 사용하여 풍부한 사용자 경험(UX)을 제공할 수 있습니다.</li></ul><h2 id="_5-다음-학습-추천" tabindex="-1">5. 다음 학습 추천 <a class="header-anchor" href="#_5-다음-학습-추천" aria-label="Permalink to &quot;5. 다음 학습 추천&quot;">​</a></h2><p>인터렉션까지 더해진 풍성한 장면에 시각적인 완성도를 높여주는 후처리 효과를 적용해 봅니다.</p><ul><li><strong><a href="./../post-effect/">포스트 이펙트</a></strong></li></ul>`,18))])}const m=o(c,[["render",k]]);export{b as __pageData,m as default};
