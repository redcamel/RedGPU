import{D as p,o as E,c as g,a2 as l,G as n,w as e,k as s,a}from"./chunks/framework.Dn9yU8Jh.js";const F=JSON.parse('{"title":"View3D","description":"RedGPU의 렌더링 단위인 View3D의 기술적 명세와 사용법을 다룹니다.","frontmatter":{"title":"View3D","description":"RedGPU의 렌더링 단위인 View3D의 기술적 명세와 사용법을 다룹니다.","order":2},"headers":[],"relativePath":"ko/view-system/view3d.md","filePath":"ko/view-system/view3d.md","lastUpdated":1769502195000}'),c={name:"ko/view-system/view3d.md"},w=Object.assign(c,{setup(y){const r=`
    graph TD
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">view.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">setPosition</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;10px&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;10%&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">[픽셀 단위 가이드]</p><p>고해상도 디스플레이(HiDPI/Retina) 대응을 위해 두 가지 좌표 객체를 제공합니다.</p><ul><li><strong><code>view.screenRectObject</code></strong>: CSS 픽셀 단위의 <strong>표시 크기</strong>(Layout Size) 입니다. <strong>UI 배치</strong>나 <strong>마우스 이벤트 좌표 계산</strong> 시에 사용합니다.</li><li><strong><code>view.pixelRectObject</code></strong>: <code>devicePixelRatio</code> 가 적용된 실제 <strong>물리 해상도</strong>(Physical Resolution) 입니다. 내부적인 렌더링 계산에 사용됩니다.</li></ul></div><h2 id="_4-디버깅-도구" tabindex="-1">4. 디버깅 도구 <a class="header-anchor" href="#_4-디버깅-도구" aria-label="Permalink to &quot;4. 디버깅 도구&quot;">​</a></h2><p>개발 중 객체의 상대적인 위치와 방향을 직관적으로 파악할 수 있도록 시각화 도구를 제공합니다.</p><ul><li><strong>grid</strong>: 3D 월드의 기본 평면(<strong>XZ</strong> 축) 에 격자를 렌더링합니다. 물체가 지면에 닿아 있는지 가늠하는 기준이 됩니다.</li><li><strong>axis</strong>: 월드의 원점(<strong>0, 0, 0</strong>) 을 기준으로 <strong>XYZ</strong> 축을 색상별로 표시합니다. <ul><li><span style="color:#ff3e3e;font-weight:bold;">Red</span>: <strong>X</strong> 축 (Right)</li><li><span style="color:#3eff3e;font-weight:bold;">Green</span>: <strong>Y</strong> 축 (Up)</li><li><span style="color:#3e3eff;font-weight:bold;">Blue</span>: <strong>Z</strong> 축 (Depth)</li></ul></li></ul><h2 id="_5-멀티-뷰-시스템" tabindex="-1">5. 멀티 뷰 시스템 <a class="header-anchor" href="#_5-멀티-뷰-시스템" aria-label="Permalink to &quot;5. 멀티 뷰 시스템&quot;">​</a></h2><p>RedGPU는 단일 컨텍스트 내에서 다수의 <strong>뷰포트</strong>(Viewport) 를 운용하는 멀티 뷰 렌더링을 지원합니다. 각 뷰는 화면의 특정 영역을 점유하며 독립적인 장면과 카메라를 렌더링합니다.</p>`,11)),n(t,null,{default:e(()=>[n(h,{definition:o})]),_:1}),i[5]||(i[5]=l(`<h3 id="멀티-뷰-구성-예제" tabindex="-1">멀티 뷰 구성 예제 <a class="header-anchor" href="#멀티-뷰-구성-예제" aria-label="Permalink to &quot;멀티 뷰 구성 예제&quot;">​</a></h3><p>앞서 배운 <strong>표시 크기</strong>(screenRectObject) 를 활용하여 메인 화면과 미니맵을 배치하는 방법입니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// [전제 조건] RedGPU.init 콜백 내부라고 가정합니다.</span></span>
