import{D as l,c as o,o as E,a2 as h,H as t,k as i,w as e,a}from"./chunks/framework.cYGcyyTy.js";const u=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{"title":"Getting Started","order":1},"headers":[],"relativePath":"en/introduction/index.md","filePath":"en/introduction/index.md","lastUpdated":1769498891000}'),g={name:"en/introduction/index.md"},F=Object.assign(g,{setup(c){const k=`
...
`,r=`
    ...
    Render --> Update
`;return(y,s)=>{const d=l("CodePen"),n=l("ClientOnly"),p=l("MermaidResponsive");return E(),o("div",null,[s[1]||(s[1]=h("",19)),t(n,null,{default:e(()=>[t(d,{title:"RedGPU Quick Start - Rotating Cube",slugHash:"getting-started"},{default:e(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
