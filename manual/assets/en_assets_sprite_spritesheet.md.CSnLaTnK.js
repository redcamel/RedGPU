...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">spriteSheet.pixelSize </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 128</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre></div><h3 id="_3-3-size-setting-policy" tabindex="-1">3.3 Size Setting Policy <a class="header-anchor" href="#_3-3-size-setting-policy" aria-label="Permalink to &quot;3.3 Size Setting Policy&quot;">​</a></h3><p><code>SpriteSheet3D</code> shares the same size setting mechanism as <code>Sprite3D</code>. It supports physical size setting in 3D space through <code>worldSize</code> and absolute pixel size setting on the screen through <code>usePixelSize</code>.</p><p>For detailed differences between modes and operating principles, please refer to the <strong><a href="./sprite.html#_3-3-relationship-between-world-size-and-pixel-size">Size Relationship section of the Sprite3D manual</a></strong>.</p><h2 id="_4-practical-example-walking-character-animation" tabindex="-1">4. Practical Example: Walking Character Animation <a class="header-anchor" href="#_4-practical-example-walking-character-animation" aria-label="Permalink to &quot;4. Practical Example: Walking Character Animation&quot;">​</a></h2><p>See how a grid-type sheet image transforms into a natural character motion through <code>SpriteSheet3D</code> and <strong>Billboard</strong> settings.</p>`,23)),n(h,null,{default:l(()=>[n(r,{title:"RedGPU - SpriteSheet3D Animation",slugHash:"spritesheet3d-basic"},{default:l(()=>[...t[0]||(t[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
...
`)]),s(`
`),e("p",null,"});"),s(`
`)],-1)])]),_:1})]),_:1}),t[2]||(t[2]=a('<hr><h2 id="key-summary" tabindex="-1">Key Summary <a class="header-anchor" href="#key-summary" aria-label="Permalink to &quot;Key Summary&quot;">​</a></h2><ul><li><strong>SpriteSheetInfo</strong>: Defines image source, sheet grid structure (Segments), animation speed (FPS), etc.</li><li><strong>Animation Control</strong>: Control visual flow through methods like <code>play</code>, <code>stop</code>, <code>gotoAndPlay</code>.</li><li><strong>Efficiency</strong>: Beneficial in terms of network overhead and GPU memory management by using a single sheet file instead of loading multiple images individually.</li></ul><hr><h2 id="next-steps" tabindex="-1">Next Steps <a class="header-anchor" href="#next-steps" aria-label="Permalink to &quot;Next Steps&quot;">​</a></h2><p>Learn how to construct and place three-dimensional text labels within 3D space.</p><ul><li><strong><a href="./../text-field/textfield3d.html">TextField3D</a></strong></li></ul>',7))])}const E=o(c,[["render",g]]);export{x as __pageData,E as default};
