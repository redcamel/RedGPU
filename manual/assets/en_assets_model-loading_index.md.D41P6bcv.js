import{$ as n,Q as d,j as k,g as s,n as a,o as e,ax as t,m as o}from"./chunks/framework.D5MFXpji.js";const m=JSON.parse('{"title":"GLTF Loader","description":"","frontmatter":{"title":"GLTF Loader","order":1},"headers":[],"relativePath":"en/assets/model-loading/index.md","filePath":"en/assets/model-loading/index.md","lastUpdated":1781136698000}'),g={name:"en/assets/model-loading/index.md"},F=Object.assign(g,{setup(E){const h=`
...
`;return(c,i)=>{const p=n("MermaidResponsive"),l=n("ClientOnly"),r=n("CodePen");return d(),k("div",null,[i[1]||(i[1]=s("h1",{id:"gltf-loader",tabindex:"-1"},[a("GLTF Loader "),s("a",{class:"header-anchor",href:"#gltf-loader","aria-label":'Permalink to "GLTF Loader"'},"​")],-1)),i[2]||(i[2]=s("p",null,[a("While you can create basic shapes with "),s("strong",null,"Primitives"),a(", high-quality assets such as detailed characters or buildings need to be created in external 3D tools (Blender, Maya, etc.) and then imported. RedGPU provides the "),s("strong",null,"GLTFLoader"),a(", which supports loading the web 3D standard format "),s("strong",null,"glTF"),a(" (GL Transmission Format) 2.0.")],-1)),e(l,null,{default:t(()=>[e(p,{definition:h})]),_:1}),i[3]||(i[3]=o(`<h2 id="_1-loading-a-model" tabindex="-1">1. Loading a Model <a class="header-anchor" href="#_1-loading-a-model" aria-label="Permalink to &quot;1. Loading a Model&quot;">​</a></h2><p>You can load <code>.gltf</code> or <code>.glb</code> files using <code>RedGPU.GLTFLoader</code>. Loading is asynchronous, and the result is delivered via a callback function upon completion.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> *</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://redcamel.github.io/RedGPU/dist/index.js&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 1. Set Camera Distance (Adjust to fit the model size)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 2. Set up IBL and a SkyBox (Key for PBR materials)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 3. Load a GLTF Model</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">GLTFLoader</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        redGPUContext,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><h3 id="live-demo" tabindex="-1">Live Demo <a class="header-anchor" href="#live-demo" aria-label="Permalink to &quot;Live Demo&quot;">​</a></h3><p>Check out the metal helmet model reflecting the IBL environment light realistically.</p>`,13)),e(l,null,{default:t(()=>[e(r,{title:"RedGPU Basics - GLTF Loader with IBL",slugHash:"gltf-loader"},{default:t(()=>[...i[0]||(i[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
