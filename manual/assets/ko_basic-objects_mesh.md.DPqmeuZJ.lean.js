import{$ as n,Q as d,j as o,m as e,o as t,ax as l,g as i,n as a}from"./chunks/framework.D5MFXpji.js";const F=JSON.parse('{"title":"Mesh","description":"","frontmatter":{"title":"Mesh","order":1},"headers":[],"relativePath":"ko/basic-objects/mesh.md","filePath":"ko/basic-objects/mesh.md","lastUpdated":1781137916000}'),g={name:"ko/basic-objects/mesh.md"},C=Object.assign(g,{setup(E){const r=`
...
`;return(y,s)=>{const p=n("MermaidResponsive"),h=n("ClientOnly"),k=n("CodePen");return d(),o("div",null,[s[1]||(s[1]=e("",5)),t(h,null,{default:l(()=>[t(p,{definition:r})]),_:1}),s[2]||(s[2]=e("",22)),t(h,null,{default:l(()=>[t(k,{title:"RedGPU Basics - Mesh Playground",slugHash:"mesh-playground"},{default:l(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
