import{D as e,o as d,c as g,a2 as t,G as n,w as h,k as i,a}from"./chunks/framework.Dn9yU8Jh.js";const F=JSON.parse('{"title":"Scene","description":"","frontmatter":{"title":"Scene","order":3},"headers":[],"relativePath":"ko/view-system/scene.md","filePath":"ko/view-system/scene.md","lastUpdated":1769502195000}'),E={name:"ko/view-system/scene.md"},C=Object.assign(E,{setup(o){const p=`
    graph TD
...
`;return(c,s)=>{const k=e("MermaidResponsive"),l=e("ClientOnly"),r=e("CodePen");return d(),g("div",null,[s[1]||(s[1]=t("",4)),n(l,null,{default:h(()=>[n(k,{definition:p})]),_:1}),s[2]||(s[2]=t("",12)),n(l,null,{default:h(()=>[n(r,{title:"RedGPU Basics - Scene Complete",slugHash:"scene-complete"},{default:h(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
