import{D as l,o as h,c as k,a2 as r,G as a,w as n,k as s,a as t}from"./chunks/framework.DpNgdNqH.js";const u=JSON.parse('{"title":"Skybox","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"ko/environment/skybox.md","filePath":"ko/environment/skybox.md","lastUpdated":1770634323000}'),g={name:"ko/environment/skybox.md"},b=Object.assign(g,{setup(c){const d=`
...
`;return(y,e)=>{const p=l("MermaidResponsive"),i=l("ClientOnly"),o=l("CodePen");return h(),k("div",null,[e[2]||(e[2]=r("",7)),a(i,null,{default:n(()=>[a(p,{definition:d})]),_:1}),e[3]||(e[3]=r("",13)),a(i,null,{default:n(()=>[a(o,{title:"RedGPU Basics - Skybox (IBL)",slugHash:"skybox-ibl"},{default:n(()=>[...e[0]||(e[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
