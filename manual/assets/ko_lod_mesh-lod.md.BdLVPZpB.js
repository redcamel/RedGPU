...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">scene.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">addChild</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(mesh);</span></span></code></pre></div><h2 id="_3-실습-예제" tabindex="-1">3. 실습 예제 <a class="header-anchor" href="#_3-실습-예제" aria-label="Permalink to &quot;3. 실습 예제&quot;">​</a></h2><p>거리에 따라 구 형태가 단순해지다가 결국 박스로 변하는 과정을 확인해 보세요.</p>`,9)),a(h,null,{default:t(()=>[a(l,{title:"RedGPU - Mesh LOD Example",slugHash:"lod-mesh-basic"},{default:t(()=>[...e[0]||(e[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
