import{D as p,o as g,c as E,a2 as l,G as e,w as n,k as i,a}from"./chunks/framework.DZW1bhNM.js";const C=JSON.parse(`{"title":"View3D","description":"Covers technical specifications and usage of View3D, RedGPU's rendering unit.","frontmatter":{"title":"View3D","description":"Covers technical specifications and usage of View3D, RedGPU's rendering unit.","order":2},"headers":[],"relativePath":"en/view-system/view3d.md","filePath":"en/view-system/view3d.md","lastUpdated":1770698112000}`),c={name:"en/view-system/view3d.md"},w=Object.assign(c,{setup(y){const k=`
    graph TD
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">view.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">setPosition</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;10px&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;10%&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">[Pixel Unit Guide]</p><p>Two coordinate objects are provided for High-DPI (Retina) display support:</p><ul><li><strong><code>view.screenRectObject</code></strong>: The <strong>Layout Size</strong> in CSS pixel units. Use this for <strong>UI placement</strong> or <strong>mouse event coordinate calculations</strong>.</li><li><strong><code>view.pixelRectObject</code></strong>: The actual <strong>Physical Resolution</strong> with <code>devicePixelRatio</code> applied. Used for internal rendering calculations.</li></ul></div><h3 id="_3-3-detection-of-per-view-size-changes-onresize" tabindex="-1">3.3 Detection of Per-View Size Changes (onResize) <a class="header-anchor" href="#_3-3-detection-of-per-view-size-changes-onresize" aria-label="Permalink to &quot;3.3 Detection of Per-View Size Changes (onResize)&quot;">​</a></h3><p>While <code>redGPUContext.onResize</code> detects size changes of the entire canvas, the <code>onResize</code> callback of an individual <strong>View3D</strong> object is called whenever the size of that specific view changes.</p><p>This is particularly useful when the view&#39;s size is set in percentages (<code>%</code>) and the parent canvas size changes, or when you explicitly change the size using <code>setSize()</code>.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// Define callback to be called when an individual view&#39;s size changes</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    console.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">log</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">\`View area changed: \${</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">width</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">}x\${</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">height</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">}\`</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // Reposition specific UI elements within that view or adjust camera settings.</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><h2 id="_4-debugging-tools" tabindex="-1">4. Debugging Tools <a class="header-anchor" href="#_4-debugging-tools" aria-label="Permalink to &quot;4. Debugging Tools&quot;">​</a></h2><p>RedGPU provides visualization tools to help intuitively understand the relative position and direction of objects during development.</p><ul><li><strong>grid</strong>: Renders a grid on the ground plane (<strong>XZ</strong> axis) of the 3D world. It serves as a reference for judging whether objects are touching the ground.</li><li><strong>axis</strong>: Displays <strong>XYZ</strong> axes in colors based on the world origin (<strong>0, 0, 0</strong>). <ul><li><span style="color:#ff3e3e;font-weight:bold;">Red</span>: <strong>X</strong> axis (Right)</li><li><span style="color:#3eff3e;font-weight:bold;">Green</span>: <strong>Y</strong> axis (Up)</li><li><span style="color:#3e3eff;font-weight:bold;">Blue</span>: <strong>Z</strong> axis (Depth)</li></ul></li></ul><h2 id="_5-multi-view-system" tabindex="-1">5. Multi-View System <a class="header-anchor" href="#_5-multi-view-system" aria-label="Permalink to &quot;5. Multi-View System&quot;">​</a></h2><p>RedGPU supports multi-view rendering, allowing the operation of multiple viewports within a single context. Each view occupies a specific area of the screen and independently renders a scene and camera.</p>`,15)),e(t,null,{default:n(()=>[e(h,{definition:o})]),_:1}),s[5]||(s[5]=l(`<h3 id="multi-view-configuration-example" tabindex="-1">Multi-View Configuration Example <a class="header-anchor" href="#multi-view-configuration-example" aria-label="Permalink to &quot;Multi-View Configuration Example&quot;">​</a></h3><p>Method for placing a main screen and a minimap utilizing <strong>Layout Size</strong> (screenRectObject) learned earlier.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// [Assumption] Inside a RedGPU.init callback.</span></span>
