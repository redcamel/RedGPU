import{$ as e,Q as r,j as d,g as s,n as a,o as n,ax as l,m as o}from"./chunks/framework.D5MFXpji.js";const F=JSON.parse('{"title":"GLTF Loader","description":"","frontmatter":{"title":"GLTF Loader","order":1},"headers":[],"relativePath":"ko/assets/model-loading/index.md","filePath":"ko/assets/model-loading/index.md","lastUpdated":1784264306000}'),E={name:"ko/assets/model-loading/index.md"},u=Object.assign(E,{setup(g){const h=`
...
`;return(y,i)=>{const p=e("MermaidResponsive"),t=e("ClientOnly"),k=e("CodePen");return r(),d("div",null,[i[1]||(i[1]=s("h1",{id:"gltf-loader",tabindex:"-1"},[a("GLTF Loader "),s("a",{class:"header-anchor",href:"#gltf-loader","aria-label":'Permalink to "GLTF Loader"'},"​")],-1)),i[2]||(i[2]=s("p",null,[s("strong",null,"Primitive"),a(" 로 기본적인 형태를 만들 수 있지만, 정교한 캐릭터나 건물 같은 고품질 에셋은 외부 3D 툴(Blender, Maya 등)에서 제작하여 가져와야 합니다. RedGPU는 웹 3D 표준 포맷인 "),s("strong",null,"glTF"),a("(GL Transmission Format) 2.0 로딩을 지원하는 "),s("strong",null,"GLTFLoader"),a(" 를 제공합니다.")],-1)),n(t,null,{default:l(()=>[n(p,{definition:h})]),_:1}),i[3]||(i[3]=o(`<h2 id="_1-모델-불러오기" tabindex="-1">1. 모델 불러오기 <a class="header-anchor" href="#_1-모델-불러오기" aria-label="Permalink to &quot;1. 모델 불러오기&quot;">​</a></h2><p><code>RedGPU.GLTFLoader</code> 를 사용하여 <code>.gltf</code> 또는 <code>.glb</code> 파일을 로드할 수 있습니다. 로딩은 비동기적으로 진행되며, 완료 시 콜백 함수를 통해 결과를 전달받습니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> *</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://redcamel.github.io/RedGPU/dist/index.js&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">    &#39;https://.../DamagedHelmet.glb&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 모델 경로</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">        // [로드 성공] loader.resultMesh가 최종 모델 객체입니다.</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div><h3 id="주요-속성-gltfloader-인스턴스" tabindex="-1">주요 속성 (GLTFLoader 인스턴스) <a class="header-anchor" href="#주요-속성-gltfloader-인스턴스" aria-label="Permalink to &quot;주요 속성 (GLTFLoader 인스턴스)&quot;">​</a></h3><ul><li><strong><code>resultMesh</code></strong>: 로드된 모델을 담고 있는 <code>RedGPU.Display.Mesh</code> 객체입니다.</li><li><strong><code>parsingResult</code></strong>: 재질, 그룹, 텍스처 등 glTF 파일의 상세 파싱 데이터입니다.</li></ul><h2 id="_2-ibl과의-시너지-필수-권장" tabindex="-1">2. IBL과의 시너지 (필수 권장) <a class="header-anchor" href="#_2-ibl과의-시너지-필수-권장" aria-label="Permalink to &quot;2. IBL과의 시너지 (필수 권장)&quot;">​</a></h2><p>외부에서 가져온 고품질 모델들은 대부분 <strong>물리 기반 렌더링</strong>(PBR) 재질을 사용합니다. 이러한 재질은 주변 환경의 빛 정보를 반사하여 질감을 표현하기 때문에, 앞서 배운 <strong>IBL</strong> 과 함께 사용할 때 가장 사실적인 결과를 얻을 수 있습니다.</p><p>IBL이 없는 환경에서 PBR 모델을 로드하면 금속 질감이 검게 보이거나 매우 어색하게 출력될 수 있습니다.</p><h2 id="_3-실습-예제-환경광과-모델-로딩" tabindex="-1">3. 실습 예제: 환경광과 모델 로딩 <a class="header-anchor" href="#_3-실습-예제-환경광과-모델-로딩" aria-label="Permalink to &quot;3. 실습 예제: 환경광과 모델 로딩&quot;">​</a></h2><p>IBL로 환경을 구성하고, 정교한 금속 헬멧 모델을 로드하는 전체 과정입니다. 카메라 컨트롤러의 <code>distance</code> 속성을 조절하여 모델을 적절한 크기로 관찰할 수 있습니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> *</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://redcamel.github.io/RedGPU/dist/index.js&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    </span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 1. 카메라 거리 설정 (모델 크기에 맞춰 조절)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 2. IBL 및 SkyBox 설정 (PBR 재질의 핵심)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 3. GLTF 모델 로딩</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    new</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> RedGPU.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">GLTFLoader</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        redGPUContext,</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div><h3 id="라이브-데모" tabindex="-1">라이브 데모 <a class="header-anchor" href="#라이브-데모" aria-label="Permalink to &quot;라이브 데모&quot;">​</a></h3><p>IBL 환경광을 받아 정교하게 반사되는 금속 헬멧 모델을 확인해 보세요.</p>`,13)),n(t,null,{default:l(()=>[n(k,{title:"RedGPU Basics - GLTF Loader with IBL",slugHash:"gltf-loader"},{default:l(()=>[...i[0]||(i[0]=[s("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
