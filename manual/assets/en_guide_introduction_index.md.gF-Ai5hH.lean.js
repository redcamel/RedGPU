import{D as l,c as o,o as E,a2 as h,H as e,k as i,w as t,a}from"./chunks/framework.cYGcyyTy.js";const m=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[],"relativePath":"en/guide/introduction/index.md","filePath":"en/guide/introduction/index.md","lastUpdated":1769498413000}'),g={name:"en/guide/introduction/index.md"},u=Object.assign(g,{setup(c){const k=`
...
`,r=`
    ...
    Render --> Update
`;return(y,s)=>{const d=l("CodePen"),n=l("ClientOnly"),p=l("MermaidResponsive");return E(),o("div",null,[s[1]||(s[1]=h("",19)),e(n,null,{default:t(()=>[e(d,{title:"RedGPU Quick Start - Rotating Cube",slugHash:"getting-started"},{default:t(()=>[...s[0]||(s[0]=[i("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
