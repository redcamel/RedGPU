import{D as l,c as p,o as k,a2 as r,H as i,k as e,w as a,a as t}from"./chunks/framework.cYGcyyTy.js";const x=JSON.parse('{"title":"Skybox","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"en/environment/skybox.md","filePath":"en/environment/skybox.md","lastUpdated":1769496586000}'),g={name:"en/environment/skybox.md"},m=Object.assign(g,{setup(c){const d=`
...
`;return(u,s)=>{const h=l("MermaidResponsive"),n=l("ClientOnly"),o=l("CodePen");return k(),p("div",null,[s[2]||(s[2]=r("",7)),i(n,null,{default:a(()=>[i(h,{definition:d})]),_:1}),s[3]||(s[3]=r("",16)),i(n,null,{default:a(()=>[i(o,{title:"RedGPU Basics - Skybox (IBL)",slugHash:"skybox-ibl"},{default:a(()=>[...s[0]||(s[0]=[e("pre",{"data-lang":"html"},`<canvas id="redgpu-canvas"></canvas>
