...
/**
 * 베이스 색상에 틴트(Tint) 색상을 지정된 블렌딩 모드로 합성합니다.
 * @param baseColor 원본 색상 (RGBA)
 * @param tintBlendMode 블렌딩 모드 인덱스 (0: NORMAL, 1: MULTIPLY, ... 22: NEGATION)
 * @param tint 합성할 틴트 색상 (RGBA)
 * @returns 합성된 최종 색상 (RGBA)
 *
 */
