...
Defined in: [src/systemCodeManager/ShaderLibrary.ts:2963](https://github.com/redcamel/RedGPU/blob/d8e9f05bb1256579c84cecea5c335fe1722c97f6/src/systemCodeManager/ShaderLibrary.ts#L2963)
...
/**
 * 클러스터 조명 격자의 한 칸(박스) 정보를 나타내는 구조체입니다.
 */
...
/**
 * 클러스터 조명 데이터를 통합 관리하는 격자(Grid) 구조체입니다.
 */
...
/**
 * 프래그먼트 좌표를 사용하여 해당 클러스터의 인덱스를 계산합니다.
 * @param fragCoord 프래그먼트 좌표
 * @returns 클러스터 인덱스
 *
 */
...
/**
 * 프래그먼트 좌표를 사용하여 해당 클러스터의 타일(XYZ) 좌표를 계산합니다.
 * @param fragCoord 프래그먼트 좌표
 * @returns 클러스터 타일 좌표
 *
 */
