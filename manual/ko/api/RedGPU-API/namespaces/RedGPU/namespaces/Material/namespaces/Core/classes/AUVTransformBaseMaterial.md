...
Defined in: [src/material/core/AUVTransformBaseMaterial.ts:29](https://github.com/redcamel/RedGPU/blob/183d0117087b28c3f28ce1934611cd3a1a56551b/src/material/core/AUVTransformBaseMaterial.ts#L29)
...
> `protected` **new AUVTransformBaseMaterial**(`redGPUContext`, `moduleName`, `fragmentSource`, `targetGroupIndex`): `AUVTransformBaseMaterial`

Defined in: [src/material/core/AUVTransformBaseMaterial.ts:56](https://github.com/redcamel/RedGPU/blob/183d0117087b28c3f28ce1934611cd3a1a56551b/src/material/core/AUVTransformBaseMaterial.ts#L56)
...
| `fragmentSource` | `string` | 프래그먼트 셰이더 소스 문자열
...
[`ABitmapBaseMaterial`](ABitmapBaseMaterial.md).[`destroy`](ABitmapBaseMaterial.md#destroy)
