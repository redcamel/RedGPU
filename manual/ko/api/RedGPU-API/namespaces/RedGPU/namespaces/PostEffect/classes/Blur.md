...
컨볼루션 기반의 단일 패스 블러(Blur) 후처리 이펙트입니다.

고정된 3x3 커널을 사용하여 이미지를 부드럽게 뭉개줍니다. 가우시안 블러보다 연산량이 적어 성능이 우수하지만, 블러의 크기(Size)를 조절할 수는 없습니다.

이 효과는 HDR 공간에서 동작하여 밝은 영역의 에너지를 보존하며 자연스러운 번짐을 제공합니다.
...
| `sourceTextureInfo` | [`IPostEffectResult`](../namespaces/Core/interfaces/IPostEffectResult.md) | 입력 텍스처 정보
