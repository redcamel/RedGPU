...
- **[구조체 표준화]**: `FragmentOutput`, `OutputShadowData`, `SYSTEM_UNIFORM`, `POST_EFFECT_SYSTEM_UNIFORM`을 `src/systemCodeManager/shader/systemStruct/`로 집결하여 시스템 차원의 데이터 규격을 통합 관리.
