...
new RedGPU.RedGPUContext(
	...
	function () {
		...
		testMat_environment = new RedGPU.RedEnvironmentMaterial(this, testTextureList[1], testCubeTexture)
		testMat_color = new RedGPU.RedColorMaterial(this, '#ffff12');
		testMat_colorPhong = new RedGPU.RedColorPhongMaterial(this, '#ffffff');
		testMat_colorPhongTexture_normal = new RedGPU.RedColorPhongTextureMaterial(this, '#fff253', 1, testTextureList[2])
		testMat_colorPhongTexture_normal_displacement = new RedGPU.RedColorPhongTextureMaterial(this, '#341fff', 1, testTextureList[2], testTextureList[5], testTextureList[6], testTextureList[4])
		console.log(testMat_colorPhong)
		testMat_bitmap = new RedGPU.RedBitmapMaterial(this, testTextureList[0]);
		testMat_standard_diffuse = new RedGPU.RedStandardMaterial(this, testTextureList[1], null, testTextureList[5], testTextureList[6]);
		testMat_standard_diffuse_normal = new RedGPU.RedStandardMaterial(this, testTextureList[0], testTextureList[2], testTextureList[5], testTextureList[6]);
		testMat_standard_diffuse_normal_displacement = new RedGPU.RedStandardMaterial(this, testTextureList[1], testTextureList[2], testTextureList[5], testTextureList[6], testTextureList[4]);
